...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____generador_de_informes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____generador_de_informes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['generador_de_informes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['generador_de_informes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['generador_de_informes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['generador_de_informes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['generador_de_informes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>generador_de_informes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['generador_de_informes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['generador_de_informes']['embutida_filho'] as $ind => $sc_init)
          {
