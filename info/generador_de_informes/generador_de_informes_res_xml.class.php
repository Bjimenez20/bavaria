...
class generador_de_informes_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['generador_de_informes']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          $lab           = "";
          $cmp           = false;
          $xml_registro  = "<generador_de_informes";
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
              {
