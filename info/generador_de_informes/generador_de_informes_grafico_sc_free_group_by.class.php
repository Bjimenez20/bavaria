...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['bayer_pacientes_id_paciente'] = "PAP";
      $prep_label['bayer_pacientes_estado_paciente'] = "ESTADO PACIENTE";
      $prep_label['bayer_pacientes_fecha_activacion_paciente'] = "FECHA ACTIVACION PACIENTE";
      $prep_label['bayer_pacientes_fecha_retiro_paciente'] = "FECHA RETIRO PACIENTE";
      $prep_label['bayer_pacientes_motivo_retiro_paciente'] = "MOTIVO RETIRO PACIENTE";
      $prep_label['bayer_pacientes_observacion_motivo_retiro_paciente'] = "OBSERVACION MOTIVO RETIRO PACIENTE";
      $prep_label['bayer_pacientes_identificacion_paciente'] = "IDENTIFICACION PACIENTE";
      $prep_label['bayer_pacientes_nombre_paciente'] = "NOMBRE PACIENTE";
      $prep_label['bayer_pacientes_apellido_paciente'] = "APELLIDO PACIENTE";
      $prep_label['bayer_pacientes_telefono_paciente'] = "TELEFONO PACIENTE";
      $prep_label['bayer_pacientes_telefono2_paciente'] = "TELEFONO2 PACIENTE";
      $prep_label['bayer_pacientes_telefono3_paciente'] = "TELEFONO3 PACIENTE";
      $prep_label['bayer_pacientes_correo_paciente'] = "CORREO PACIENTE";
      $prep_label['bayer_pacientes_direccion_paciente'] = "DIRECCION PACIENTE";
      $prep_label['bayer_pacientes_barrio_paciente'] = "BARRIO PACIENTE";
      $prep_label['bayer_pacientes_departamento_paciente'] = "DEPARTAMENTO PACIENTE";
      $prep_label['bayer_pacientes_ciudad_paciente'] = "CIUDAD PACIENTE";
      $prep_label['bayer_pacientes_genero_paciente'] = "GENERO PACIENTE";
      $prep_label['bayer_pacientes_fecha_nacimineto_paciente'] = "FECHA NACIMINETO PACIENTE";
      $prep_label['bayer_pacientes_edad_paciente'] = "EDAD PACIENTE";
      $prep_label['bayer_pacientes_acudiente_paciente'] = "ACUDIENTE PACIENTE";
      $prep_label['bayer_pacientes_telefono_acudiente_paciente'] = "TELEFONO ACUDIENTE PACIENTE";
      $prep_label['bayer_pacientes_codigo_xofigo'] = "CODIGO XOFIGO";
      $prep_label['bayer_pacientes_status_paciente'] = "STATUS PACIENTE";
      $prep_label['bayer_pacientes_id_ultima_gestion'] = "ID ULTIMA GESTION";
      $prep_label['bayer_pacientes_usuario_creacion'] = "USUARIO CREACION";
      $prep_label['bayer_tratamiento_id_tratamiento'] = "ID TRATAMIENTO";
      $prep_label['bayer_tratamiento_producto_tratamiento'] = "PRODUCTO TRATAMIENTO";
      $prep_label['bayer_tratamiento_nombre_referencia'] = "NOMBRE REFERENCIA";
      $prep_label['bayer_tratamiento_clasificacion_patologica_tratamiento'] = "CLASIFICACION PATOLOGICA TRATAMIENTO";
      $prep_label['bayer_tratamiento_tratamiento_previo'] = "TRATAMIENTO PREVIO";
      $prep_label['bayer_tratamiento_consentimiento_tratamiento'] = "CONSENTIMIENTO TRATAMIENTO";
      $prep_label['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "FECHA INICIO TERAPIA TRATAMIENTO";
      $prep_label['bayer_tratamiento_regimen_tratamiento'] = "REGIMEN TRATAMIENTO";
      $prep_label['bayer_tratamiento_asegurador_tratamiento'] = "ASEGURADOR TRATAMIENTO";
      $prep_label['bayer_tratamiento_operador_logistico_tratamiento'] = "OPERADOR LOGISTICO TRATAMIENTO";
      $prep_label['bayer_tratamiento_punto_entrega'] = "PUNTO ENTREGA";
      $prep_label['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'] = "FECHA ULTIMA RECLAMACION TRATAMIENTO";
      $prep_label['bayer_tratamiento_otros_operadores_tratamiento'] = "OTROS OPERADORES TRATAMIENTO";
      $prep_label['bayer_tratamiento_medios_adquisicion_tratamiento'] = "MEDIOS ADQUISICION TRATAMIENTO";
      $prep_label['bayer_tratamiento_ips_atiende_tratamiento'] = "IPS ATIENDE TRATAMIENTO";
      $prep_label['bayer_tratamiento_medico_tratamiento'] = "MEDICO TRATAMIENTO";
      $prep_label['bayer_tratamiento_especialidad_tratamiento'] = "ESPECIALIDAD TRATAMIENTO";
      $prep_label['bayer_tratamiento_paramedico_tratamiento'] = "PARAMEDICO TRATAMIENTO";
      $prep_label['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] = "ZONA ATENCION PARAMEDICO TRATAMIENTO";
      $prep_label['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] = "CIUDAD BASE PARAMEDICO TRATAMIENTO";
      $prep_label['bayer_tratamiento_notas_adjuntos_tratamiento'] = "NOTAS ADJUNTOS TRATAMIENTO";
      $prep_label['bayer_tratamiento_id_paciente_fk'] = "ID PACIENTE FK";
      $prep_label['bayer_gestiones_id_gestion'] = "ID GESTION";
      $prep_label['bayer_gestiones_motivo_comunicacion_gestion'] = "MOTIVO COMUNICACION GESTION";
      $prep_label['bayer_gestiones_medio_contacto_gestion'] = "MEDIO CONTACTO GESTION";
      $prep_label['bayer_gestiones_tipo_llamada_gestion'] = "TIPO LLAMADA GESTION";
      $prep_label['bayer_gestiones_logro_comunicacion_gestion'] = "LOGRO COMUNICACION GESTION";
      $prep_label['bayer_gestiones_motivo_no_comunicacion_gestion'] = "MOTIVO NO COMUNICACION GESTION";
      $prep_label['bayer_gestiones_numero_intentos_gestion'] = "NUMERO INTENTOS GESTION";
      $prep_label['bayer_gestiones_esperado_gestion'] = "ESPERADO GESTION";
      $prep_label['bayer_gestiones_estado_ctc_gestion'] = "ESTADO CTC GESTION";
      $prep_label['bayer_gestiones_estado_farmacia_gestion'] = "ESTADO FARMACIA GESTION";
      $prep_label['bayer_gestiones_reclamo_gestion'] = "RECLAMO GESTION";
      $prep_label['bayer_gestiones_causa_no_reclamacion_gestion'] = "CAUSA NO RECLAMACION GESTION";
      $prep_label['bayer_gestiones_dificultad_acceso_gestion'] = "DIFICULTAD ACCESO GESTION";
      $prep_label['bayer_gestiones_tipo_dificultad_gestion'] = "TIPO DIFICULTAD GESTION";
      $prep_label['bayer_gestiones_envios_gestion'] = "ENVIOS GESTION";
      $prep_label['bayer_gestiones_medicamentos_gestion'] = "MEDICAMENTOS GESTION";
      $prep_label['bayer_gestiones_tipo_envio_gestion'] = "TIPO ENVIO GESTION";
      $prep_label['bayer_gestiones_evento_adverso_gestion'] = "EVENTO ADVERSO GESTION";
      $prep_label['bayer_gestiones_tipo_evento_adverso'] = "TIPO EVENTO ADVERSO";
      $prep_label['bayer_gestiones_genera_solicitud_gestion'] = "GENERA SOLICITUD GESTION";
      $prep_label['bayer_gestiones_fecha_proxima_llamada'] = "FECHA PROXIMA LLAMADA";
      $prep_label['bayer_gestiones_motivo_proxima_llamada'] = "MOTIVO PROXIMA LLAMADA";
      $prep_label['bayer_gestiones_observacion_proxima_llamada'] = "OBSERVACION PROXIMA LLAMADA";
      $prep_label['bayer_gestiones_fecha_reclamacion_gestion'] = "FECHA RECLAMACION GESTION";
      $prep_label['bayer_gestiones_consecutivo_gestion'] = "CONSECUTIVO GESTION";
      $prep_label['bayer_gestiones_autor_gestion'] = "AUTOR GESTION";
      $prep_label['bayer_gestiones_nota'] = "NOTA";
      $prep_label['bayer_gestiones_fecha_programada_gestion'] = "FECHA PROGRAMADA GESTION";
      $prep_label['bayer_gestiones_usuario_asigando'] = "USUARIO ASIGANDO";
      $prep_label['bayer_gestiones_id_paciente_fk2'] = "ID PACIENTE FK2";
      $prep_label['bayer_gestiones_fecha_comunicacion'] = "FECHA COMUNICACION";
      $prep_label['bayer_gestiones_estado_gestion'] = "ESTADO GESTION";
      $prep_label['bayer_gestiones_codigo_argus'] = "CODIGO ARGUS";
      $prep_label['bayer_gestiones_numero_cajas'] = "NUMERO CAJAS";
      $x = 0;
