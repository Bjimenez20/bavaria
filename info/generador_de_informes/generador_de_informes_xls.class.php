...
class generador_de_informes_xls
{
   ...
   function grava_arquivo()
   {
      ...
      { 
          ...
          if ($Cada_col == "bayer_tratamiento_consentimiento_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "bayer_tratamiento_otros_operadores_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "bayer_tratamiento_medios_adquisicion_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "bayer_tratamiento_paramedico_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "bayer_tratamiento_ciudad_base_paramedico_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
          ...
          if ($Cada_col == "bayer_tratamiento_notas_adjuntos_tratamiento" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = sc_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
   ...
   function NM_export_bayer_pacientes_telefono2_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono2_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_telefono3_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono3_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_correo_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_correo_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_direccion_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_direccion_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_barrio_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_barrio_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_genero_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_genero_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_fecha_nacimineto_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_fecha_nacimineto_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_edad_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_pacientes_edad_paciente))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_edad_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_acudiente_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_acudiente_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_telefono_acudiente_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono_acudiente_paciente);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_id_ultima_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_pacientes_id_ultima_gestion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
   ...
   {
         $this->bayer_pacientes_usuario_creacion = html_entity_decode($this->bayer_pacientes_usuario_creacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_pacientes_usuario_creacion = strip_tags($this->bayer_pacientes_usuario_creacion);
         if (!NM_is_utf8($this->bayer_pacientes_usuario_creacion))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_usuario_creacion);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_id_tratamiento
   function NM_export_bayer_tratamiento_id_tratamiento()
   {
         if (!NM_is_utf8($this->bayer_tratamiento_id_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_tratamiento_id_tratamiento))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_id_tratamiento);
         $this->xls_col++;
   }
   ...
   {
         $this->bayer_tratamiento_clasificacion_patologica_tratamiento = html_entity_decode($this->bayer_tratamiento_clasificacion_patologica_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_clasificacion_patologica_tratamiento = strip_tags($this->bayer_tratamiento_clasificacion_patologica_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_clasificacion_patologica_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_clasificacion_patologica_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_tratamiento_previo
   function NM_export_bayer_tratamiento_tratamiento_previo()
   {
         $this->bayer_tratamiento_tratamiento_previo = html_entity_decode($this->bayer_tratamiento_tratamiento_previo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_tratamiento_previo = strip_tags($this->bayer_tratamiento_tratamiento_previo);
         if (!NM_is_utf8($this->bayer_tratamiento_tratamiento_previo))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_tratamiento_previo);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_consentimiento_tratamiento
   function NM_export_bayer_tratamiento_consentimiento_tratamiento()
   {
         $this->bayer_tratamiento_consentimiento_tratamiento = html_entity_decode($this->bayer_tratamiento_consentimiento_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_consentimiento_tratamiento = strip_tags($this->bayer_tratamiento_consentimiento_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_consentimiento_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_consentimiento_tratamiento);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_fecha_inicio_terapia_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_fecha_inicio_terapia_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_regimen_tratamiento
   function NM_export_bayer_tratamiento_regimen_tratamiento()
   {
         $this->bayer_tratamiento_regimen_tratamiento = html_entity_decode($this->bayer_tratamiento_regimen_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_regimen_tratamiento = strip_tags($this->bayer_tratamiento_regimen_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_regimen_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_regimen_tratamiento);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento()
   {
         ...
         if (!NM_is_utf8($this->bayer_tratamiento_fecha_ultima_reclamacion_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_fecha_ultima_reclamacion_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_otros_operadores_tratamiento
   function NM_export_bayer_tratamiento_otros_operadores_tratamiento()
   {
         $this->bayer_tratamiento_otros_operadores_tratamiento = html_entity_decode($this->bayer_tratamiento_otros_operadores_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_otros_operadores_tratamiento = strip_tags($this->bayer_tratamiento_otros_operadores_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_otros_operadores_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_otros_operadores_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_medios_adquisicion_tratamiento
   function NM_export_bayer_tratamiento_medios_adquisicion_tratamiento()
   {
         $this->bayer_tratamiento_medios_adquisicion_tratamiento = html_entity_decode($this->bayer_tratamiento_medios_adquisicion_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_medios_adquisicion_tratamiento = strip_tags($this->bayer_tratamiento_medios_adquisicion_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_medios_adquisicion_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_medios_adquisicion_tratamiento);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_ips_atiende_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_ips_atiende_tratamiento);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_medico_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_medico_tratamiento);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_especialidad_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_especialidad_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_paramedico_tratamiento
   function NM_export_bayer_tratamiento_paramedico_tratamiento()
   {
         $this->bayer_tratamiento_paramedico_tratamiento = html_entity_decode($this->bayer_tratamiento_paramedico_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_paramedico_tratamiento = strip_tags($this->bayer_tratamiento_paramedico_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_paramedico_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_paramedico_tratamiento);
         $this->xls_col++;
   }
   ...
   {
         $this->bayer_tratamiento_zona_atencion_paramedico_tratamiento = html_entity_decode($this->bayer_tratamiento_zona_atencion_paramedico_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_zona_atencion_paramedico_tratamiento = strip_tags($this->bayer_tratamiento_zona_atencion_paramedico_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_zona_atencion_paramedico_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_zona_atencion_paramedico_tratamiento);
         $this->xls_col++;
   }
   ...
   {
         $this->bayer_tratamiento_ciudad_base_paramedico_tratamiento = html_entity_decode($this->bayer_tratamiento_ciudad_base_paramedico_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_ciudad_base_paramedico_tratamiento = strip_tags($this->bayer_tratamiento_ciudad_base_paramedico_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_ciudad_base_paramedico_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_ciudad_base_paramedico_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_notas_adjuntos_tratamiento
   function NM_export_bayer_tratamiento_notas_adjuntos_tratamiento()
   {
         $this->bayer_tratamiento_notas_adjuntos_tratamiento = html_entity_decode($this->bayer_tratamiento_notas_adjuntos_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_notas_adjuntos_tratamiento = strip_tags($this->bayer_tratamiento_notas_adjuntos_tratamiento);
         if (!NM_is_utf8($this->bayer_tratamiento_notas_adjuntos_tratamiento))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_notas_adjuntos_tratamiento);
         $this->xls_col++;
   }
   //----- bayer_tratamiento_id_paciente_fk
   function NM_export_bayer_tratamiento_id_paciente_fk()
   {
         if (!NM_is_utf8($this->bayer_tratamiento_id_paciente_fk))
         {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_tratamiento_id_paciente_fk))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_id_paciente_fk);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_medio_contacto_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_medio_contacto_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_tipo_llamada_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_tipo_llamada_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_motivo_no_comunicacion_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_motivo_no_comunicacion_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_numero_intentos_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_numero_intentos_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_esperado_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_esperado_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_estado_ctc_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_estado_ctc_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_estado_farmacia_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_estado_farmacia_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_dificultad_acceso_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_dificultad_acceso_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_tipo_dificultad_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_tipo_dificultad_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_envios_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_envios_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_medicamentos_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_medicamentos_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_tipo_envio_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_tipo_envio_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_evento_adverso_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_evento_adverso_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_tipo_evento_adverso()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_tipo_evento_adverso);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_genera_solicitud_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_genera_solicitud_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_fecha_proxima_llamada()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_fecha_proxima_llamada);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_motivo_proxima_llamada()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_motivo_proxima_llamada);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_observacion_proxima_llamada()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_observacion_proxima_llamada);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_consecutivo_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_consecutivo_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_nota()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_nota);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_descripcion_comunicacion_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_descripcion_comunicacion_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_usuario_asigando()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_usuario_asigando);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_estado_gestion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_estado_gestion);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_gestiones_codigo_argus()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_gestiones_codigo_argus);
         $this->xls_col++;
   }
