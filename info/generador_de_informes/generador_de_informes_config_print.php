 ...
 */
    ...
    session_start();
    $SC_apl_proc = "generador_de_informes";
...
<form name="config_prt" method="post" action="generador_de_informes_config_print.php">
<?php
...
if ($opc == "AM")
{
    if (isset($_SESSION['sc_session'][$page][$SC_apl_proc]['scroll_navigate']) && $_SESSION['sc_session'][$page][$SC_apl_proc]['scroll_navigate'])
    {
?>
     opc = "RC";
<?php
