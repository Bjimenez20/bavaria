...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["bayer_fundem_____BAYER_GESTION"]))
   {
      unset($_SESSION['session_sec_aplicacao']["bayer_fundem_____BAYER_GESTION"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['BAYER_GESTION']['embutida_filho'] as $ind => $sc_init)
          {
