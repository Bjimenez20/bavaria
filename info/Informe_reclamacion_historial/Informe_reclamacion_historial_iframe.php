...
$oExportPdf = new Informe_reclamacion_historial_export_pdf;
$oExportPdf->exportPdf();

class Informe_reclamacion_historial_export_pdf {
...
$STR_btn    = '';
$STR_lang   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']))
{
    $STR_schema = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']['str_schema'];
    $STR_tmp    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']['str_tmp'];
    $STR_prod   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']['str_prod'];
    $STR_btn    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']['str_btn'];
    $STR_lang   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['Informe_reclamacion_historial']['Informe_reclamacion_historial_iframe_params']['str_lang'];
}
$Nm_lang     = array();
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Informe_reclamacion_historial_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Informe_reclamacion_historial.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial']['pdf_name'] : "Informe_reclamacion_historial.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$path_doc_md5 = md5($NM_pdfurl . "/" . $NM_pdfbase);
$_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
$_SESSION['sc_session'][$aParams['script_case_init']]['Informe_reclamacion_historial'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
