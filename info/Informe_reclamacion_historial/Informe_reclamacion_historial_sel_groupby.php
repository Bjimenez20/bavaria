...
function Sel_processa_form()
{
   ...
   $arr_campos_free['bayer_pacientes_id_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion_historial']['labels']['bayer_pacientes_id_paciente'])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion_historial']['labels']['bayer_pacientes_id_paciente'] : "ID PACIENTE";
   $arr_campos_free['bayer_pacientes_estado_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion_historial']['labels']['bayer_pacientes_estado_paciente'])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion_historial']['labels']['bayer_pacientes_estado_paciente'] : "ESTADO PACIENTE";
