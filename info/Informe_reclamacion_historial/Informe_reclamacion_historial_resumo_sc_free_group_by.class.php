...
class Informe_reclamacion_historial_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
      ...
      {
          $this->array_total_bayer_pacientes_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['bayer_pacientes_id_paciente'];
          $this->array_total_bayer_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['bayer_pacientes_estado_paciente'];
      }
      else
      {
          $this->array_total_bayer_pacientes_id_paciente = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['bayer_pacientes_id_paciente'] = $this->array_total_bayer_pacientes_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['arr_total']['bayer_pacientes_estado_paciente'] = $this->array_total_bayer_pacientes_estado_paciente;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['bayer_pacientes_id_paciente'] = "ID PACIENTE";
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['bayer_gestiones.RECLAMO_GESTION']['alin'] = "''";
       $Arr_parms['bayer_gestiones.RECLAMO_GESTION']['link'] = "S";
       $Arr_parms['bayer_gestiones.CAUSA_NO_RECLAMACION_GESTION']['alin'] = "''";
       $Arr_parms['bayer_gestiones.CAUSA_NO_RECLAMACION_GESTION']['link'] = "S";
       $Arr_parms['bayer_gestiones.FECHA_RECLAMACION_GESTION']['alin'] = "''";
       $Arr_parms['bayer_gestiones.FECHA_RECLAMACION_GESTION']['link'] = "S";
       $Arr_parms['bayer_gestiones.FECHA_COMUNICACION']['alin'] = "''";
       $Arr_parms['bayer_gestiones.FECHA_COMUNICACION']['link'] = "S";
       ...
       $prep_links_fl['bayer_gestiones.RECLAMO_GESTION'] = array(0 => 'bayer_gestiones.RECLAMO_GESTION', 1 => '@aspass@');
       $prep_links_fl['bayer_gestiones.CAUSA_NO_RECLAMACION_GESTION'] = array(0 => 'bayer_gestiones.CAUSA_NO_RECLAMACION_GESTION', 1 => '@aspass@');
       $prep_links_fl['bayer_gestiones.FECHA_RECLAMACION_GESTION'] = array(0 => 'bayer_gestiones.FECHA_RECLAMACION_GESTION', 1 => '@aspass@');
       $prep_links_fl['bayer_gestiones.FECHA_COMUNICACION'] = array(0 => 'bayer_gestiones.FECHA_COMUNICACION', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_bayer_pacientes_id_paciente, $quebra_bayer_pacientes_estado_paciente, $quebra_bayer_pacientes_id_paciente_orig, $quebra_bayer_pacientes_estado_paciente_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion_historial']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->bayer_gestiones_logro_comunicacion_gestion = $rs_res->fields[1] ;  
            $this->bayer_gestiones_fecha_comunicacion = $rs_res->fields[2] ;  
            $this->bayer_gestiones_autor_gestion = $rs_res->fields[3] ;  
            $this->bayer_pacientes_departamento_paciente = $rs_res->fields[4] ;  
            $this->bayer_pacientes_ciudad_paciente = $rs_res->fields[5] ;  
            $this->bayer_pacientes_estado_paciente = $rs_res->fields[6] ;  
            $this->bayer_pacientes_status_paciente = $rs_res->fields[7] ;  
            $this->bayer_pacientes_fecha_activacion_paciente = $rs_res->fields[8] ;  
            $this->bayer_pacientes_codigo_xofigo = $rs_res->fields[9] ;  
            $this->bayer_tratamiento_producto_tratamiento = $rs_res->fields[10] ;  
            $this->bayer_tratamiento_nombre_referencia = $rs_res->fields[11] ;  
            $this->bayer_tratamiento_dosis_tratamiento = $rs_res->fields[12] ;  
            $this->bayer_gestiones_numero_cajas = $rs_res->fields[13] ;  
            $this->bayer_tratamiento_asegurador_tratamiento = $rs_res->fields[14] ;  
            $this->bayer_tratamiento_operador_logistico_tratamiento = $rs_res->fields[15] ;  
            $this->bayer_tratamiento_punto_entrega = $rs_res->fields[16] ;  
            $this->bayer_gestiones_reclamo_gestion = $rs_res->fields[17] ;  
            $this->bayer_gestiones_fecha_reclamacion_gestion = $rs_res->fields[18] ;  
            $this->bayer_gestiones_causa_no_reclamacion_gestion = $rs_res->fields[19] ;  
            $this->bayer_historial_reclamacion_id_historial_reclamacion = $rs_res->fields[20] ;  
            $this->bayer_historial_reclamacion_anio_historial_reclamacion = $rs_res->fields[21] ;  
            $this->bayer_historial_reclamacion_mes1 = $rs_res->fields[22] ;  
            $this->bayer_historial_reclamacion_reclamo1 = $rs_res->fields[23] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion1 = $rs_res->fields[24] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion1 = $rs_res->fields[25] ;  
            $this->bayer_historial_reclamacion_mes2 = $rs_res->fields[26] ;  
            $this->bayer_historial_reclamacion_reclamo2 = $rs_res->fields[27] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion2 = $rs_res->fields[28] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion2 = $rs_res->fields[29] ;  
            $this->bayer_historial_reclamacion_mes3 = $rs_res->fields[30] ;  
            $this->bayer_historial_reclamacion_reclamo3 = $rs_res->fields[31] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion3 = $rs_res->fields[32] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion3 = $rs_res->fields[33] ;  
            $this->bayer_historial_reclamacion_mes4 = $rs_res->fields[34] ;  
            $this->bayer_historial_reclamacion_reclamo4 = $rs_res->fields[35] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion4 = $rs_res->fields[36] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion4 = $rs_res->fields[37] ;  
            $this->bayer_historial_reclamacion_mes5 = $rs_res->fields[38] ;  
            $this->bayer_historial_reclamacion_reclamo5 = $rs_res->fields[39] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion5 = $rs_res->fields[40] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion5 = $rs_res->fields[41] ;  
            $this->bayer_historial_reclamacion_mes6 = $rs_res->fields[42] ;  
            $this->bayer_historial_reclamacion_reclamo6 = $rs_res->fields[43] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion6 = $rs_res->fields[44] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion6 = $rs_res->fields[45] ;  
            $this->bayer_historial_reclamacion_mes7 = $rs_res->fields[46] ;  
            $this->bayer_historial_reclamacion_reclamo7 = $rs_res->fields[47] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion7 = $rs_res->fields[48] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion7 = $rs_res->fields[49] ;  
            $this->bayer_historial_reclamacion_mes8 = $rs_res->fields[50] ;  
            $this->bayer_historial_reclamacion_reclamo8 = $rs_res->fields[51] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion8 = $rs_res->fields[52] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion8 = $rs_res->fields[53] ;  
            $this->bayer_historial_reclamacion_mes9 = $rs_res->fields[54] ;  
            $this->bayer_historial_reclamacion_reclamo9 = $rs_res->fields[55] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion9 = $rs_res->fields[56] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion9 = $rs_res->fields[57] ;  
            $this->bayer_historial_reclamacion_mes10 = $rs_res->fields[58] ;  
            $this->bayer_historial_reclamacion_reclamo10 = $rs_res->fields[59] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion10 = $rs_res->fields[60] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion10 = $rs_res->fields[61] ;  
            $this->bayer_historial_reclamacion_mes11 = $rs_res->fields[62] ;  
            $this->bayer_historial_reclamacion_reclamo11 = $rs_res->fields[63] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion11 = $rs_res->fields[64] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion11 = $rs_res->fields[65] ;  
            $this->bayer_historial_reclamacion_mes12 = $rs_res->fields[66] ;  
            $this->bayer_historial_reclamacion_reclamo12 = $rs_res->fields[67] ;  
            $this->bayer_historial_reclamacion_fecha_reclamacion12 = $rs_res->fields[68] ;  
            $this->bayer_historial_reclamacion_motivo_no_reclamacion12 = $rs_res->fields[69] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->bayer_pacientes_id_paciente, $this->bayer_pacientes_estado_paciente, $this->bayer_pacientes_id_paciente_orig,  $this->bayer_pacientes_estado_paciente_orig);
            }
   }
//
