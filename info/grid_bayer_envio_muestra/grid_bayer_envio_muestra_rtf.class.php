...
class grid_bayer_envio_muestra_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_bayer_envio_muestra_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "grid_bayer_envio_muestra.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_name']);
      }
   ...
   function NM_export_bayer_envio_muestra_estatus_paciente()
   {
         ...
         $this->bayer_envio_muestra_estatus_paciente = str_replace('<', '&lt;', $this->bayer_envio_muestra_estatus_paciente);
         $this->bayer_envio_muestra_estatus_paciente = str_replace('>', '&gt;', $this->bayer_envio_muestra_estatus_paciente);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_estatus_paciente . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_dosis()
   {
         ...
         $this->bayer_envio_muestra_dosis = str_replace('<', '&lt;', $this->bayer_envio_muestra_dosis);
         $this->bayer_envio_muestra_dosis = str_replace('>', '&gt;', $this->bayer_envio_muestra_dosis);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_dosis . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_fecha_salida()
   {
         ...
         $this->bayer_envio_muestra_fecha_salida = str_replace('<', '&lt;', $this->bayer_envio_muestra_fecha_salida);
         $this->bayer_envio_muestra_fecha_salida = str_replace('>', '&gt;', $this->bayer_envio_muestra_fecha_salida);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_fecha_salida . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_fecha_entrega()
   {
         ...
         $this->bayer_envio_muestra_fecha_entrega = str_replace('<', '&lt;', $this->bayer_envio_muestra_fecha_entrega);
         $this->bayer_envio_muestra_fecha_entrega = str_replace('>', '&gt;', $this->bayer_envio_muestra_fecha_entrega);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_fecha_entrega . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_no_lote()
   {
         ...
         $this->bayer_envio_muestra_no_lote = str_replace('<', '&lt;', $this->bayer_envio_muestra_no_lote);
         $this->bayer_envio_muestra_no_lote = str_replace('>', '&gt;', $this->bayer_envio_muestra_no_lote);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_no_lote . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_estado()
   {
         ...
         $this->bayer_envio_muestra_estado = str_replace('<', '&lt;', $this->bayer_envio_muestra_estado);
         $this->bayer_envio_muestra_estado = str_replace('>', '&gt;', $this->bayer_envio_muestra_estado);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_estado . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_usuario()
   {
         ...
         $this->bayer_envio_muestra_usuario = str_replace('<', '&lt;', $this->bayer_envio_muestra_usuario);
         $this->bayer_envio_muestra_usuario = str_replace('>', '&gt;', $this->bayer_envio_muestra_usuario);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_usuario . "</td>\r\n";
   }
   ...
   function NM_export_bayer_envio_muestra_fecha_creacion()
   {
         ...
         $this->bayer_envio_muestra_fecha_creacion = str_replace('<', '&lt;', $this->bayer_envio_muestra_fecha_creacion);
         $this->bayer_envio_muestra_fecha_creacion = str_replace('>', '&gt;', $this->bayer_envio_muestra_fecha_creacion);
         $this->texto_tag .= "<td>" . $this->bayer_envio_muestra_fecha_creacion . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - bayer_envio_muestra :: RTF</TITLE>
