...
class grid_bayer_envio_muestra_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_bayer_envio_muestra_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_bayer_envio_muestra.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_bayer_envio_muestra";
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_estatus_paciente))
         {
         ...
         $this->xml_registro .= " bayer_envio_muestra_estatus_paciente =\"" . $this->trata_dados($this->bayer_envio_muestra_estatus_paciente) . "\"";
   }
   //----- bayer_envio_muestra_dosis
   function NM_export_bayer_envio_muestra_dosis()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_dosis))
         {
             $this->bayer_envio_muestra_dosis = sc_convert_encoding($this->bayer_envio_muestra_dosis, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " bayer_envio_muestra_dosis =\"" . $this->trata_dados($this->bayer_envio_muestra_dosis) . "\"";
   }
   //----- bayer_envio_muestra_fecha_salida
   function NM_export_bayer_envio_muestra_fecha_salida()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_fecha_salida))
         {
         ...
         $this->xml_registro .= " bayer_envio_muestra_fecha_salida =\"" . $this->trata_dados($this->bayer_envio_muestra_fecha_salida) . "\"";
   }
   //----- bayer_envio_muestra_fecha_entrega
   function NM_export_bayer_envio_muestra_fecha_entrega()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_fecha_entrega))
         {
         ...
         $this->xml_registro .= " bayer_envio_muestra_fecha_entrega =\"" . $this->trata_dados($this->bayer_envio_muestra_fecha_entrega) . "\"";
   }
   //----- bayer_envio_muestra_no_lote
   function NM_export_bayer_envio_muestra_no_lote()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_no_lote))
         {
             $this->bayer_envio_muestra_no_lote = sc_convert_encoding($this->bayer_envio_muestra_no_lote, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " bayer_envio_muestra_no_lote =\"" . $this->trata_dados($this->bayer_envio_muestra_no_lote) . "\"";
   }
   //----- bayer_envio_muestra_estado
   function NM_export_bayer_envio_muestra_estado()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_estado))
         {
             $this->bayer_envio_muestra_estado = sc_convert_encoding($this->bayer_envio_muestra_estado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " bayer_envio_muestra_estado =\"" . $this->trata_dados($this->bayer_envio_muestra_estado) . "\"";
   }
   //----- bayer_envio_muestra_usuario
   function NM_export_bayer_envio_muestra_usuario()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_usuario))
         {
             $this->bayer_envio_muestra_usuario = sc_convert_encoding($this->bayer_envio_muestra_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " bayer_envio_muestra_usuario =\"" . $this->trata_dados($this->bayer_envio_muestra_usuario) . "\"";
   }
   ...
   function NM_export_bayer_envio_muestra_fecha_creacion()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->bayer_envio_muestra_fecha_creacion))
         {
         ...
         $this->xml_registro .= " bayer_envio_muestra_fecha_creacion =\"" . $this->trata_dados($this->bayer_envio_muestra_fecha_creacion) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_bayer_envio_muestra']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - bayer_envio_muestra :: XML</TITLE>
