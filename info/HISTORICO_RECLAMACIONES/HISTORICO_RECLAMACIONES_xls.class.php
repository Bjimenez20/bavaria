...
class HISTORICO_RECLAMACIONES_xls
{
   ...
   function NM_export_bayer_pacientes_id_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_pacientes_id_paciente))
         {
   ...
   function NM_export_bayer_pacientes_departamento_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_departamento_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_estado_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_estado_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_status_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_status_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_fecha_activacion_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_fecha_activacion_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_producto_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_producto_tratamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_nombre_referencia()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_nombre_referencia, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_dosis_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_dosis_tratamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_punto_entrega()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_punto_entrega, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_anio_historial_reclamacion()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->bayer_historial_reclamacion_anio_historial_reclamacion))
         {
             $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,##0');
         }
   ...
   function NM_export_bayer_historial_reclamacion_mes1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion1()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion1, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion2()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion2, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion3()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion3, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion4()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion4, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion5()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion5, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion6()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion6, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion7()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion7, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion8()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion8, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion9()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion9, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion10()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion10, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion11()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion11, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_mes12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_mes12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_reclamo12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_reclamo12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_fecha_reclamacion12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_fecha_reclamacion12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_historial_reclamacion_motivo_no_reclamacion12()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_historial_reclamacion_motivo_no_reclamacion12, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
