...
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "bayer_brindar_apoyo_fecha_apoyo";
   $tab_ger_campos['bayer_brindar_apoyo_motivo'] = "on";
   $tab_blk_campos[] = "bayer_brindar_apoyo_motivo";
   $tab_ger_campos['bayer_brindar_apoyo_dosis'] = "on";
   $tab_blk_campos[] = "bayer_brindar_apoyo_dosis";
   $tab_ger_campos['mes'] = "on";
   $tab_blk_campos[] = "mes";
   $tab_ger_campos['bayer_brindar_apoyo_razon_apoyo'] = "on";
   $tab_blk_campos[] = "bayer_brindar_apoyo_razon_apoyo";
