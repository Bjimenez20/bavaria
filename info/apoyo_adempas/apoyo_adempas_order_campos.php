...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["bayer_pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_id_paciente"] : "PAP";
   ...
   $tab_labels["bayer_pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   $tab_ger_campos['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "bayer_tratamiento_fecha_inicio_terapia_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_fecha_inicio_terapia_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"] : "FECHA INICIO TERAPIA TRATAMIENTO";
   $tab_ger_campos['bayer_brindar_apoyo_fecha_apoyo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_brindar_apoyo_fecha_apoyo'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "bayer_brindar_apoyo_fecha_apoyo";
   }
   else
   {
       $tab_def_campos['bayer_brindar_apoyo_fecha_apoyo'] = "bayer_brindar_apoyo.FECHA_APOYO";
       $tab_converte["bayer_brindar_apoyo.FECHA_APOYO"]   = "bayer_brindar_apoyo_fecha_apoyo";
   }
   $tab_labels["bayer_brindar_apoyo_fecha_apoyo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_fecha_apoyo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_fecha_apoyo"] : "FECHA APOYO";
   $tab_ger_campos['bayer_brindar_apoyo_motivo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_brindar_apoyo_motivo'] = "bayer_brindar_apoyo_motivo";
       $tab_converte["bayer_brindar_apoyo_motivo"]   = "bayer_brindar_apoyo_motivo";
   }
   else
   {
       $tab_def_campos['bayer_brindar_apoyo_motivo'] = "bayer_brindar_apoyo.MOTIVO";
       $tab_converte["bayer_brindar_apoyo.MOTIVO"]   = "bayer_brindar_apoyo_motivo";
   }
   $tab_labels["bayer_brindar_apoyo_motivo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_motivo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_motivo"] : "MOTIVO";
   $tab_ger_campos['bayer_brindar_apoyo_dosis'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_brindar_apoyo_dosis'] = "bayer_brindar_apoyo_dosis";
       $tab_converte["bayer_brindar_apoyo_dosis"]   = "bayer_brindar_apoyo_dosis";
   }
   else
   {
       $tab_def_campos['bayer_brindar_apoyo_dosis'] = "bayer_brindar_apoyo.DOSIS";
       $tab_converte["bayer_brindar_apoyo.DOSIS"]   = "bayer_brindar_apoyo_dosis";
   }
   $tab_labels["bayer_brindar_apoyo_dosis"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_dosis"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_dosis"] : "DOSIS";
   ...
   {
       $tab_def_campos['mes'] = "DATE_FORMAT(bayer_brindar_apoyo.FECHA_APOYO,'%m')";
       $tab_converte["DATE_FORMAT(bayer_brindar_apoyo.FECHA_APOYO,'%m')"]   = "mes";
   }
   ...
   $tab_ger_campos['bayer_brindar_apoyo_razon_apoyo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_brindar_apoyo_razon_apoyo'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "bayer_brindar_apoyo_razon_apoyo";
   }
   else
   {
       $tab_def_campos['bayer_brindar_apoyo_razon_apoyo'] = "bayer_brindar_apoyo.RAZON_APOYO";
       $tab_converte["bayer_brindar_apoyo.RAZON_APOYO"]   = "bayer_brindar_apoyo_razon_apoyo";
   }
   $tab_labels["bayer_brindar_apoyo_razon_apoyo"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_razon_apoyo"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_brindar_apoyo_razon_apoyo"] : "RAZON APOYO";
   $tab_ger_campos['bayer_tratamiento_asegurador_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_asegurador_tratamiento'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "bayer_tratamiento_asegurador_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_operador_logistico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_operador_logistico_tratamiento'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "bayer_tratamiento_operador_logistico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_medico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_medico_tratamiento'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "bayer_tratamiento_medico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_tratamiento_medico_tratamiento"] : "MEDICO TRATANTE";
   $tab_ger_campos['bayer_pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_ciudad_paciente'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "bayer_pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   $tab_ger_campos['bayer_pacientes_departamento_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_departamento_paciente'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "bayer_pacientes_departamento_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['apoyo_adempas']['labels']["bayer_pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
