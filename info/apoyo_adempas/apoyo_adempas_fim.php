...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____apoyo_adempas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____apoyo_adempas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['apoyo_adempas']['embutida_filho'] as $ind => $sc_init)
          {
