...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_bayer_envio_muestra") . "/grid_bayer_envio_muestra_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra']) == "on")
{
    $menu_informes_menuData['data'] .= "item_12|.|" . $nm_var_lab[11] . "|menu_informes_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_bayer_envio_muestra&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_informes_target('_self') . "|" . "\n";
}
else
{
...
$str_disabled = "N";
$str_link = "menu_informes_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_bayer_envio_muestra&sc_apl_link=" . urlencode($menu_informes_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_informes']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_bayer_envio_muestra']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
