...
class ultima_gestion_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
      ...
      {
          $this->array_total_bayer_gestiones_fecha_programada_gestion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_fecha_programada_gestion'];
          $this->array_total_bayer_gestiones_fecha_comunicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_fecha_comunicacion'];
          $this->array_total_bayer_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_pacientes_estado_paciente'];
          $this->array_total_bayer_tratamiento_producto_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_tratamiento_producto_tratamiento'];
          $this->array_total_bayer_gestiones_autor_gestion = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_autor_gestion'];
      }
      else
      {
          $this->array_total_bayer_gestiones_fecha_programada_gestion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_fecha_programada_gestion'] = $this->array_total_bayer_gestiones_fecha_programada_gestion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_fecha_comunicacion'] = $this->array_total_bayer_gestiones_fecha_comunicacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_pacientes_estado_paciente'] = $this->array_total_bayer_pacientes_estado_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_tratamiento_producto_tratamiento'] = $this->array_total_bayer_tratamiento_producto_tratamiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_total']['bayer_gestiones_autor_gestion'] = $this->array_total_bayer_gestiones_autor_gestion;
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_bayer_gestiones_fecha_programada_gestion, $this->array_total_bayer_gestiones_fecha_comunicacion, $this->array_total_bayer_pacientes_estado_paciente, $this->array_total_bayer_tratamiento_producto_tratamiento, $this->array_total_bayer_gestiones_autor_gestion);
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_bayer_gestiones_fecha_programada_gestion, $quebra_bayer_gestiones_fecha_comunicacion, $quebra_bayer_pacientes_estado_paciente, $quebra_bayer_tratamiento_producto_tratamiento, $quebra_bayer_gestiones_autor_gestion, $quebra_bayer_gestiones_fecha_programada_gestion_orig, $quebra_bayer_gestiones_fecha_comunicacion_orig, $quebra_bayer_pacientes_estado_paciente_orig, $quebra_bayer_tratamiento_producto_tratamiento_orig, $quebra_bayer_gestiones_autor_gestion_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->bayer_pacientes_identificacion_paciente = $rs_res->fields[5] ;  
            $this->bayer_pacientes_observacion_motivo_retiro_paciente = $rs_res->fields[6] ;  
            ...
            $this->bayer_pacientes_id_ultima_gestion = $rs_res->fields[10] ;  
            $this->bayer_gestiones_id_gestion = $rs_res->fields[11] ;  
            $this->bayer_gestiones_motivo_comunicacion_gestion = $rs_res->fields[12] ;  
            $this->bayer_gestiones_fecha_programada_gestion = $rs_res->fields[13] ;  
            $this->bayer_gestiones_fecha_comunicacion = $rs_res->fields[14] ;  
            $this->bayer_tratamiento_producto_tratamiento = $rs_res->fields[15] ;  
            $this->bayer_gestiones_autor_gestion = $rs_res->fields[16] ;  
            $this->bayer_gestiones_fecha_comunicacion = substr($this->bayer_gestiones_fecha_comunicacion, 0, 7);
            ...
            $this->nm_data->SetaData($this->bayer_gestiones_fecha_comunicacion, "YYYY-MM");
            $this->bayer_gestiones_fecha_comunicacion = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "mmaaaa"));
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->bayer_gestiones_fecha_programada_gestion, $this->bayer_gestiones_fecha_comunicacion, $this->bayer_pacientes_estado_paciente, $this->bayer_tratamiento_producto_tratamiento, $this->bayer_gestiones_autor_gestion, $this->bayer_gestiones_fecha_programada_gestion_orig,  $this->bayer_gestiones_fecha_comunicacion_orig,  $this->bayer_pacientes_estado_paciente_orig,  $this->bayer_tratamiento_producto_tratamiento_orig,  $this->bayer_gestiones_autor_gestion_orig);
            }
   }
//
