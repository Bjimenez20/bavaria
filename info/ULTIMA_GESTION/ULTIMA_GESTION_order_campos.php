...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["bayer_pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_id_paciente"] : "PAP";
   ...
   $tab_labels["bayer_pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_fecha_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_fecha_retiro_paciente"] : "FECHA RETIRO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_motivo_retiro_paciente"] : "MOTIVO RETIRO PACIENTE";
   $tab_ger_campos['bayer_pacientes_identificacion_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_identificacion_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "bayer_pacientes_identificacion_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_identificacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_identificacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_identificacion_paciente"] : "IDENTIFICACION PACIENTE";
   $tab_ger_campos['bayer_pacientes_observacion_motivo_retiro_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_observacion_motivo_retiro_paciente'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "bayer_pacientes_observacion_motivo_retiro_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_observacion_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_observacion_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_observacion_motivo_retiro_paciente"] : "OBSERVACION MOTIVO RETIRO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   ...
   $tab_labels["bayer_pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   $tab_ger_campos['bayer_pacientes_id_ultima_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_id_ultima_gestion'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "bayer_pacientes_id_ultima_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_id_ultima_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_id_ultima_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_pacientes_id_ultima_gestion"] : "ID ULTIMA GESTION";
   ...
   $tab_labels["bayer_gestiones_id_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_id_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_id_gestion"] : "ID GESTION";
   $tab_ger_campos['bayer_gestiones_motivo_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_motivo_comunicacion_gestion'] = "cmp_maior_30_11";
       $tab_converte["cmp_maior_30_11"]   = "bayer_gestiones_motivo_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_motivo_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_motivo_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_motivo_comunicacion_gestion"] : "MOTIVO COMUNICACION GESTION";
   $tab_ger_campos['bayer_gestiones_fecha_programada_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_fecha_programada_gestion'] = "cmp_maior_30_12";
       $tab_converte["cmp_maior_30_12"]   = "bayer_gestiones_fecha_programada_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_fecha_programada_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_fecha_programada_gestion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_fecha_programada_gestion"] : "FECHA PROGRAMADA GESTION";
   $tab_ger_campos['bayer_gestiones_fecha_comunicacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_fecha_comunicacion'] = "cmp_maior_30_13";
       $tab_converte["cmp_maior_30_13"]   = "bayer_gestiones_fecha_comunicacion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']["bayer_gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
