...
class ultima_gestion_res_xml
{
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['ultima_gestion']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
