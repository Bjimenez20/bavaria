...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____ultima_gestion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____ultima_gestion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ultima_gestion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['ultima_gestion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['ultima_gestion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['ultima_gestion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['ultima_gestion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['ultima_gestion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['ultima_gestion']['embutida_filho'] as $ind => $sc_init)
          {
