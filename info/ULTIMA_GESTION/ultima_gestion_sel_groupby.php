...
function Sel_processa_out($sel_groupby)
{
   ...
   elseif ($sel_groupby != $groupby_atual || $Change_free_groupby)
   {
       ...
       if ($sel_groupby == "sc_free_group_by")
       {
           ...
           $tab_arr_groubby_cmp['bayer_gestiones_fecha_programada_gestion'] = array('cmp' => "bayer_gestiones.FECHA_PROGRAMADA_GESTION", 'ind' => 0);
           $tab_arr_groubby_cmp['bayer_gestiones_fecha_comunicacion'] = array('cmp' => "bayer_gestiones.FECHA_COMUNICACION", 'ind' => 1);
           $tab_arr_groubby_cmp['bayer_pacientes_estado_paciente'] = array('cmp' => "bayer_pacientes.ESTADO_PACIENTE", 'ind' => 2);
           $tab_arr_groubby_cmp['bayer_tratamiento_producto_tratamiento'] = array('cmp' => "bayer_tratamiento.PRODUCTO_TRATAMIENTO", 'ind' => 3);
           $tab_arr_groubby_cmp['bayer_gestiones_autor_gestion'] = array('cmp' => "bayer_gestiones.AUTOR_GESTION", 'ind' => 4);
           $tab_arr_groubby_sql[0] = array('cmp' => "bayer_gestiones.FECHA_PROGRAMADA_GESTION", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "bayer_gestiones.FECHA_COMUNICACION", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "bayer_pacientes.ESTADO_PACIENTE", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "bayer_tratamiento.PRODUCTO_TRATAMIENTO", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "bayer_gestiones.AUTOR_GESTION", 'ord' => 'asc');
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['bayer_gestiones_fecha_programada_gestion']  = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_fecha_programada_gestion'])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_fecha_programada_gestion'] : "FECHA PROGRAMADA GESTION";
   $arr_campos_free['bayer_gestiones_fecha_comunicacion']  = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_fecha_comunicacion'])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_fecha_comunicacion'] : "FECHA COMUNICACION";
   $arr_campos_free['bayer_pacientes_estado_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_pacientes_estado_paciente'])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_pacientes_estado_paciente'] : "ESTADO PACIENTE";
   $arr_campos_free['bayer_tratamiento_producto_tratamiento']  = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_tratamiento_producto_tratamiento'])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_tratamiento_producto_tratamiento'] : "PRODUCTO TRATAMIENTO";
   $arr_campos_free['bayer_gestiones_autor_gestion']  = (isset($_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_autor_gestion'])) ? $_SESSION['sc_session'][$sc_init]['ultima_gestion']['labels']['bayer_gestiones_autor_gestion'] : "AUTOR GESTION";
