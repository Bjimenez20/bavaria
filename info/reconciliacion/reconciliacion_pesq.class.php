...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_bayer_gestiones_fecha_comunicacion')
      {
          $bayer_gestiones_fecha_comunicacion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_bayer_gestiones_fecha_comunicacion($bayer_gestiones_fecha_comunicacion);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_bayer_gestiones_fecha_comunicacion($bayer_gestiones_fecha_comunicacion)
   {
      $bayer_gestiones_fecha_comunicacion = substr($this->Db->qstr($bayer_gestiones_fecha_comunicacion), 1, -1);
            $bayer_gestiones_fecha_comunicacion_look = substr($this->Db->qstr($bayer_gestiones_fecha_comunicacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct bayer_gestiones.FECHA_COMUNICACION from " . $this->Ini->nm_tabela . " where  bayer_gestiones.FECHA_COMUNICACION like '%" . $bayer_gestiones_fecha_comunicacion . "%'"; 
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_bayer_gestiones_fecha_comunicacion#NMF#' + search_get_text('SC_bayer_gestiones_fecha_comunicacion') + '@NMF@';
  str_out += 'id_ac_bayer_gestiones_fecha_comunicacion#NMF#' + search_get_text('id_ac_bayer_gestiones_fecha_comunicacion') + '@NMF@';
  str_out += 'SC_bayer_gestiones_fecha_comunicacion_input_2#NMF#' + search_get_text('SC_bayer_gestiones_fecha_comunicacion_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_bayer_gestiones_fecha_comunicacion").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_bayer_gestiones_fecha_comunicacion",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_bayer_gestiones_fecha_comunicacion").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_bayer_gestiones_fecha_comunicacion").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      global 
             $bayer_gestiones_fecha_comunicacion_cond, $bayer_gestiones_fecha_comunicacion, $bayer_gestiones_fecha_comunicacion_input_2, $bayer_gestiones_fecha_comunicacion_autocomp,
      ...
      { 
          ...
          $bayer_gestiones_fecha_comunicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion']; 
          $bayer_gestiones_fecha_comunicacion_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion_input_2']; 
          $bayer_gestiones_fecha_comunicacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion_cond']; 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['bayer_gestiones_fecha_comunicacion'])) ? $this->New_label['bayer_gestiones_fecha_comunicacion'] : "FECHA COMUNICACION"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_bayer_gestiones_fecha_comunicacion_cond" name="bayer_gestiones_fecha_comunicacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_bayer_gestiones_fecha_comunicacion'), this, 'bayer_gestiones_fecha_comunicacion')">
       ...
       <OPTION value="qp" <?php if ("qp" == $bayer_gestiones_fecha_comunicacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
...
<?php
      $bayer_gestiones_fecha_comunicacion_look = substr($this->Db->qstr($bayer_gestiones_fecha_comunicacion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct bayer_gestiones.FECHA_COMUNICACION from " . $this->Ini->nm_tabela . " where bayer_gestiones.FECHA_COMUNICACION = '$bayer_gestiones_fecha_comunicacion_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$bayer_gestiones_fecha_comunicacion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$bayer_gestiones_fecha_comunicacion];
      }
      else
      {
          $sAutocompValue = $bayer_gestiones_fecha_comunicacion;
      }
?>
<INPUT  type="text" id="SC_bayer_gestiones_fecha_comunicacion" name="bayer_gestiones_fecha_comunicacion" value="<?php echo NM_encode_input($bayer_gestiones_fecha_comunicacion) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_bayer_gestiones_fecha_comunicacion" name="bayer_gestiones_fecha_comunicacion_autocomp" size="10" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_bayer_gestiones_fecha_comunicacion"  <?php echo $str_display_bayer_gestiones_fecha_comunicacion; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_bayer_gestiones_fecha_comunicacion_input_2" name="bayer_gestiones_fecha_comunicacion_input_2" value="<?php echo NM_encode_input($bayer_gestiones_fecha_comunicacion_input_2) ?>"   size="10" class="sc-js-input sc-js-input scFilterObjectOdd">
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.bayer_gestiones_fecha_comunicacion.value = "";
   document.F1.bayer_gestiones_fecha_comunicacion_autocomp.value = "";
   document.F1.bayer_gestiones_fecha_comunicacion_input_2.value = "";
 }
...
<?php
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_bayer_gestiones_fecha_comunicacion'] = 'text_aut';
      $tp_fields['id_ac_bayer_gestiones_fecha_comunicacion'] = 'text_aut';
      $tp_fields['SC_bayer_gestiones_fecha_comunicacion_input_2'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $bayer_gestiones_fecha_comunicacion_cond, $bayer_gestiones_fecha_comunicacion, $bayer_gestiones_fecha_comunicacion_input_2, $bayer_gestiones_fecha_comunicacion_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($bayer_gestiones_fecha_comunicacion_autocomp) && empty($bayer_gestiones_fecha_comunicacion))
      {
          $bayer_gestiones_fecha_comunicacion = $bayer_gestiones_fecha_comunicacion_autocomp;
      }
      $bayer_gestiones_fecha_comunicacion_cond_salva = $bayer_gestiones_fecha_comunicacion_cond; 
      if (!isset($bayer_gestiones_fecha_comunicacion_input_2) || $bayer_gestiones_fecha_comunicacion_input_2 == "")
      {
          $bayer_gestiones_fecha_comunicacion_input_2 = $bayer_gestiones_fecha_comunicacion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion'] = $bayer_gestiones_fecha_comunicacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion_input_2'] = $bayer_gestiones_fecha_comunicacion_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['reconciliacion']['campos_busca']['bayer_gestiones_fecha_comunicacion_cond'] = $bayer_gestiones_fecha_comunicacion_cond_salva; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['bayer_gestiones_fecha_comunicacion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['bayer_gestiones_fecha_comunicacion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['bayer_gestiones_fecha_comunicacion'] = $bayer_gestiones_fecha_comunicacion;
      }
      $Conteudo = $bayer_gestiones_fecha_comunicacion_input_2;
      $this->cmp_formatado['bayer_gestiones_fecha_comunicacion_input_2'] = $Conteudo;

      //----- $bayer_gestiones_fecha_comunicacion
      $this->Date_part = false;
      if (isset($bayer_gestiones_fecha_comunicacion) || $bayer_gestiones_fecha_comunicacion_cond == "nu" || $bayer_gestiones_fecha_comunicacion_cond == "nn" || $bayer_gestiones_fecha_comunicacion_cond == "ep" || $bayer_gestiones_fecha_comunicacion_cond == "ne")
      {
         $this->monta_condicao("bayer_gestiones.FECHA_COMUNICACION", $bayer_gestiones_fecha_comunicacion_cond, $bayer_gestiones_fecha_comunicacion, $bayer_gestiones_fecha_comunicacion_input_2, "bayer_gestiones_fecha_comunicacion");
      }
   }
