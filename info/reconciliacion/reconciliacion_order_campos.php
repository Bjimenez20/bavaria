...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["bayer_pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_id_paciente"] : "CODIGO DE USUARIO";
   ...
   $tab_labels["bayer_gestiones_fecha_comunicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_fecha_comunicacion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_fecha_comunicacion"] : "FECHA COMUNICACION";
   ...
   $tab_labels["bayer_pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_nombre_paciente"] : "NOMBRE";
   ...
   $tab_labels["bayer_pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_apellido_paciente"] : "APELLIDO";
   $tab_ger_campos['bayer_tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_producto_tratamiento'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "bayer_tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_tratamiento_producto_tratamiento"] : "PRODUCTO";
   $tab_ger_campos['bayer_pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_ciudad_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "bayer_pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_pacientes_ciudad_paciente"] : "CIUDAD";
   $tab_ger_campos['bayer_gestiones_evento_adverso_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_evento_adverso_gestion'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "bayer_gestiones_evento_adverso_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_evento_adverso_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_evento_adverso_gestion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_evento_adverso_gestion"] : "EVENTO ADVERSO";
   ...
   $tab_labels["bayer_gestiones_codigo_argus"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_codigo_argus"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_codigo_argus"] : "CODIGO ARGUS";
   ...
   $tab_labels["bayer_gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['reconciliacion']['labels']["bayer_gestiones_autor_gestion"] : "AUTOR";
