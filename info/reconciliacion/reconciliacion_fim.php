...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____reconciliacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____reconciliacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reconciliacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reconciliacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reconciliacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reconciliacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reconciliacion']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reconciliacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reconciliacion']['embutida_filho'] as $ind => $sc_init)
          {
