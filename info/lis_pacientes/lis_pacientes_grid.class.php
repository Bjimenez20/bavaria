...
class lis_pacientes_grid
{
   ...
   var $bayer_pacientes_motivo_retiro_paciente_Old;
   var $arg_sum_bayer_pacientes_motivo_retiro_paciente;
   var $Label_bayer_pacientes_motivo_retiro_paciente;
   var $sc_proc_quebra_bayer_pacientes_motivo_retiro_paciente;
   var $count_bayer_pacientes_motivo_retiro_paciente;
   var $bayer_pacientes_genero_paciente_Old;
   var $arg_sum_bayer_pacientes_genero_paciente;
   var $Label_bayer_pacientes_genero_paciente;
   var $sc_proc_quebra_bayer_pacientes_genero_paciente;
   var $count_bayer_pacientes_genero_paciente;
   var $bayer_tratamiento_producto_tratamiento_Old;
   var $arg_sum_bayer_tratamiento_producto_tratamiento;
   var $Label_bayer_tratamiento_producto_tratamiento;
   var $sc_proc_quebra_bayer_tratamiento_producto_tratamiento;
   var $count_bayer_tratamiento_producto_tratamiento;
   var $bayer_tratamiento_medico_tratamiento_Old;
   var $arg_sum_bayer_tratamiento_medico_tratamiento;
   var $Label_bayer_tratamiento_medico_tratamiento;
   ...
   var $bayer_pacientes_fecha_retiro_paciente;
   var $bayer_pacientes_motivo_retiro_paciente;
   var $bayer_pacientes_observacion_motivo_retiro_paciente;
   var $bayer_pacientes_identificacion_paciente;
   var $bayer_pacientes_nombre_paciente;
   var $bayer_pacientes_apellido_paciente;
   var $bayer_pacientes_telefono_paciente;
   var $bayer_pacientes_telefono2_paciente;
   var $bayer_pacientes_telefono3_paciente;
   var $bayer_pacientes_correo_paciente;
   var $bayer_pacientes_direccion_paciente;
   var $bayer_pacientes_barrio_paciente;
   var $bayer_pacientes_departamento_paciente;
   var $bayer_pacientes_ciudad_paciente;
   var $bayer_pacientes_genero_paciente;
   var $bayer_pacientes_fecha_nacimineto_paciente;
   var $bayer_pacientes_edad_paciente;
   var $bayer_pacientes_acudiente_paciente;
   var $bayer_pacientes_telefono_acudiente_paciente;
   var $bayer_pacientes_codigo_xofigo;
   var $bayer_pacientes_status_paciente;
   var $bayer_pacientes_id_ultima_gestion;
   var $bayer_pacientes_usuario_creacion;
   var $bayer_tratamiento_id_tratamiento;
   var $bayer_tratamiento_producto_tratamiento;
   var $bayer_tratamiento_nombre_referencia;
   var $bayer_tratamiento_clasificacion_patologica_tratamiento;
   var $bayer_tratamiento_tratamiento_previo;
   var $bayer_tratamiento_consentimiento_tratamiento;
   var $bayer_tratamiento_fecha_inicio_terapia_tratamiento;
   var $bayer_tratamiento_regimen_tratamiento;
   ...
   var $bayer_tratamiento_fecha_ultima_reclamacion_tratamiento;
   var $bayer_tratamiento_otros_operadores_tratamiento;
   var $bayer_tratamiento_medios_adquisicion_tratamiento;
   var $bayer_tratamiento_ips_atiende_tratamiento;
   var $bayer_tratamiento_medico_tratamiento;
   var $bayer_tratamiento_especialidad_tratamiento;
   var $bayer_tratamiento_paramedico_tratamiento;
   var $bayer_tratamiento_zona_atencion_paramedico_tratamiento;
   var $bayer_tratamiento_ciudad_base_paramedico_tratamiento;
   var $bayer_tratamiento_notas_adjuntos_tratamiento;
//--- 
...
//
   ...
   $this->sc_proc_quebra_bayer_pacientes_motivo_retiro_paciente = false;
   $this->sc_proc_quebra_bayer_pacientes_genero_paciente = false;
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = false;
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = false;
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'])
   { 
   ...
   $this->Cmps_ord_def['bayer_pacientes_id_paciente'] = " asc";
   $this->Cmps_ord_def['bayer_pacientes.ID_PACIENTE'] = "";
   $this->Cmps_ord_def['cmp_maior_30_1'] = " asc";
   $this->Cmps_ord_def['bayer_pacientes.ESTADO_PACIENTE'] = "";
   $this->Cmps_ord_def['cmp_maior_30_2'] = " desc";
   $this->Cmps_ord_def['bayer_pacientes.FECHA_ACTIVACION_PACIENTE'] = "";
   $this->Cmps_ord_def['cmp_maior_30_3'] = " desc";
   $this->Cmps_ord_def['bayer_pacientes.FECHA_RETIRO_PACIENTE'] = "";
   $this->Cmps_ord_def['cmp_maior_30_4'] = " asc";
   $this->Cmps_ord_def['bayer_pacientes.MOTIVO_RETIRO_PACIENTE'] = "";
   $this->Cmps_ord_def['cmp_maior_30_5'] = " asc";
   $this->Cmps_ord_def['bayer_pacientes.OBSERVACION_MOTIVO_RETIRO_PACIENTE'] = "";
   ...
   { 
       ...
       $bayer_pacientes_id_paciente_2 = $Busca_temp['bayer_pacientes_id_paciente_input_2']; 
...
//
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       { 
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_sql']['bayer_pacientes.ID_PACIENTE']))
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['ordem_select']['bayer_pacientes.ID_PACIENTE'] = 'DESC'; 
           } 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Ind_Groupby'] == "sc_free_group_by") 
...
// 
   ...
   $this->arg_sum_bayer_pacientes_motivo_retiro_paciente = "";
   $this->count_bayer_pacientes_motivo_retiro_paciente = 0;
   $this->arg_sum_bayer_pacientes_genero_paciente = "";
   $this->count_bayer_pacientes_genero_paciente = 0;
   $this->arg_sum_bayer_tratamiento_producto_tratamiento = "";
   $this->count_bayer_tratamiento_producto_tratamiento = 0;
   $this->arg_sum_bayer_tratamiento_medico_tratamiento = "";
   $this->count_bayer_tratamiento_medico_tratamiento = 0;
...
//----- 
   ...
   { 
       ...
       $this->bayer_pacientes_estado_paciente = $this->rs_grid->fields[1] ;  
       $this->bayer_pacientes_fecha_activacion_paciente = $this->rs_grid->fields[2] ;  
       $this->bayer_pacientes_fecha_retiro_paciente = $this->rs_grid->fields[3] ;  
       $this->bayer_pacientes_motivo_retiro_paciente = $this->rs_grid->fields[4] ;  
       $this->bayer_pacientes_observacion_motivo_retiro_paciente = $this->rs_grid->fields[5] ;  
       $this->bayer_pacientes_identificacion_paciente = $this->rs_grid->fields[6] ;  
       $this->bayer_pacientes_nombre_paciente = $this->rs_grid->fields[7] ;  
       $this->bayer_pacientes_apellido_paciente = $this->rs_grid->fields[8] ;  
       $this->bayer_pacientes_telefono_paciente = $this->rs_grid->fields[9] ;  
       $this->bayer_pacientes_telefono2_paciente = $this->rs_grid->fields[10] ;  
       $this->bayer_pacientes_telefono3_paciente = $this->rs_grid->fields[11] ;  
       $this->bayer_pacientes_correo_paciente = $this->rs_grid->fields[12] ;  
       $this->bayer_pacientes_direccion_paciente = $this->rs_grid->fields[13] ;  
       $this->bayer_pacientes_barrio_paciente = $this->rs_grid->fields[14] ;  
       $this->bayer_pacientes_departamento_paciente = $this->rs_grid->fields[15] ;  
       $this->bayer_pacientes_ciudad_paciente = $this->rs_grid->fields[16] ;  
       $this->bayer_pacientes_genero_paciente = $this->rs_grid->fields[17] ;  
       $this->bayer_pacientes_fecha_nacimineto_paciente = $this->rs_grid->fields[18] ;  
       $this->bayer_pacientes_edad_paciente = $this->rs_grid->fields[19] ;  
       $this->bayer_pacientes_edad_paciente = (string)$this->bayer_pacientes_edad_paciente;
       $this->bayer_pacientes_acudiente_paciente = $this->rs_grid->fields[20] ;  
       $this->bayer_pacientes_telefono_acudiente_paciente = $this->rs_grid->fields[21] ;  
       $this->bayer_pacientes_codigo_xofigo = $this->rs_grid->fields[22] ;  
       $this->bayer_pacientes_codigo_xofigo = (string)$this->bayer_pacientes_codigo_xofigo;
       $this->bayer_pacientes_status_paciente = $this->rs_grid->fields[23] ;  
       $this->bayer_pacientes_id_ultima_gestion = $this->rs_grid->fields[24] ;  
       $this->bayer_pacientes_id_ultima_gestion = (string)$this->bayer_pacientes_id_ultima_gestion;
       $this->bayer_pacientes_usuario_creacion = $this->rs_grid->fields[25] ;  
       $this->bayer_tratamiento_id_tratamiento = $this->rs_grid->fields[26] ;  
       $this->bayer_tratamiento_id_tratamiento = (string)$this->bayer_tratamiento_id_tratamiento;
       $this->bayer_tratamiento_producto_tratamiento = $this->rs_grid->fields[27] ;  
       $this->bayer_tratamiento_nombre_referencia = $this->rs_grid->fields[28] ;  
       $this->bayer_tratamiento_clasificacion_patologica_tratamiento = $this->rs_grid->fields[29] ;  
       $this->bayer_tratamiento_tratamiento_previo = $this->rs_grid->fields[30] ;  
       $this->bayer_tratamiento_consentimiento_tratamiento = $this->rs_grid->fields[31] ;  
       $this->bayer_tratamiento_fecha_inicio_terapia_tratamiento = $this->rs_grid->fields[32] ;  
       $this->bayer_tratamiento_regimen_tratamiento = $this->rs_grid->fields[33] ;  
       $this->bayer_tratamiento_asegurador_tratamiento = $this->rs_grid->fields[34] ;  
       $this->bayer_tratamiento_operador_logistico_tratamiento = $this->rs_grid->fields[35] ;  
       $this->bayer_tratamiento_punto_entrega = $this->rs_grid->fields[36] ;  
       $this->bayer_tratamiento_fecha_ultima_reclamacion_tratamiento = $this->rs_grid->fields[37] ;  
       $this->bayer_tratamiento_otros_operadores_tratamiento = $this->rs_grid->fields[38] ;  
       $this->bayer_tratamiento_medios_adquisicion_tratamiento = $this->rs_grid->fields[39] ;  
       $this->bayer_tratamiento_ips_atiende_tratamiento = $this->rs_grid->fields[40] ;  
       $this->bayer_tratamiento_medico_tratamiento = $this->rs_grid->fields[41] ;  
       $this->bayer_tratamiento_especialidad_tratamiento = $this->rs_grid->fields[42] ;  
       $this->bayer_tratamiento_paramedico_tratamiento = $this->rs_grid->fields[43] ;  
       $this->bayer_tratamiento_zona_atencion_paramedico_tratamiento = $this->rs_grid->fields[44] ;  
       $this->bayer_tratamiento_ciudad_base_paramedico_tratamiento = $this->rs_grid->fields[45] ;  
       $this->bayer_tratamiento_notas_adjuntos_tratamiento = $this->rs_grid->fields[46] ;  
       ...
       if (!isset($this->bayer_pacientes_motivo_retiro_paciente)) { $this->bayer_pacientes_motivo_retiro_paciente = ""; }
       if (!isset($this->bayer_pacientes_genero_paciente)) { $this->bayer_pacientes_genero_paciente = ""; }
       if (!isset($this->bayer_tratamiento_producto_tratamiento)) { $this->bayer_tratamiento_producto_tratamiento = ""; }
       if (!isset($this->bayer_tratamiento_medico_tratamiento)) { $this->bayer_tratamiento_medico_tratamiento = ""; }
       ...
       $this->arg_sum_bayer_pacientes_motivo_retiro_paciente = " = " . $this->Db->qstr($this->bayer_pacientes_motivo_retiro_paciente);
       $this->arg_sum_bayer_pacientes_genero_paciente = " = " . $this->Db->qstr($this->bayer_pacientes_genero_paciente);
       $this->arg_sum_bayer_tratamiento_producto_tratamiento = " = " . $this->Db->qstr($this->bayer_tratamiento_producto_tratamiento);
       $this->arg_sum_bayer_tratamiento_medico_tratamiento = " = " . $this->Db->qstr($this->bayer_tratamiento_medico_tratamiento);
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Ind_Groupby'] == "sc_free_group_by") 
       {
           ...
           $this->bayer_pacientes_motivo_retiro_paciente_Old = $this->bayer_pacientes_motivo_retiro_paciente ; 
           $this->bayer_pacientes_genero_paciente_Old = $this->bayer_pacientes_genero_paciente ; 
           $this->bayer_tratamiento_producto_tratamiento_Old = $this->bayer_tratamiento_producto_tratamiento ; 
           $this->bayer_tratamiento_medico_tratamiento_Old = $this->bayer_tratamiento_medico_tratamiento ; 
           $sql_where = "";
...
// 
 function label_grid($linhas = 0)
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_label'] . "\" >&nbsp;</TD>\r\n");
   } 
 ...
 function NM_label_bayer_pacientes_id_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_id_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_id_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      ...
      {
          $NM_cmp_class =  "bayer_pacientes.ID_PACIENTE";
      }
      ...
      {
          $NM_cmp_class =  "bayer_pacientes_id_paciente";
      }
      $link_img = "";
 ...
 function NM_label_bayer_pacientes_estado_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_estado_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_estado_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "bayer_pacientes.ESTADO_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "bayer_pacientes.ESTADO_PACIENTE";
 ...
 function NM_label_bayer_pacientes_fecha_activacion_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_fecha_activacion_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_fecha_activacion_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "bayer_pacientes.FECHA_ACTIVACION_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "bayer_pacientes.FECHA_ACTIVACION_PACIENTE";
 ...
 function NM_label_bayer_pacientes_fecha_retiro_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_fecha_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_fecha_retiro_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_fecha_retiro_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_fecha_retiro_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "bayer_pacientes.FECHA_RETIRO_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "bayer_pacientes.FECHA_RETIRO_PACIENTE";
 ...
 function NM_label_bayer_pacientes_motivo_retiro_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_motivo_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_motivo_retiro_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_motivo_retiro_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_motivo_retiro_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "bayer_pacientes.MOTIVO_RETIRO_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "bayer_pacientes.MOTIVO_RETIRO_PACIENTE";
 ...
 function NM_label_bayer_pacientes_observacion_motivo_retiro_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_observacion_motivo_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_observacion_motivo_retiro_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_observacion_motivo_retiro_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_observacion_motivo_retiro_paciente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] != "pdf")
   {
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $NM_cmp_class =  "bayer_pacientes.OBSERVACION_MOTIVO_RETIRO_PACIENTE";
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      {
          $NM_cmp_class =  "bayer_pacientes.OBSERVACION_MOTIVO_RETIRO_PACIENTE";
 ...
 function NM_label_bayer_pacientes_identificacion_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_identificacion_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_identificacion_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_identificacion_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_identificacion_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_nombre_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_nombre_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_nombre_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_nombre_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_nombre_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_apellido_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_apellido_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_apellido_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_apellido_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_apellido_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_telefono_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_telefono_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_telefono_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_telefono2_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono2_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono2_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_telefono2_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_telefono2_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_telefono3_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono3_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono3_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_telefono3_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_telefono3_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_correo_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_correo_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_correo_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_correo_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_correo_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_direccion_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_direccion_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_direccion_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_direccion_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_direccion_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_barrio_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_barrio_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_barrio_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_barrio_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_barrio_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_departamento_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_departamento_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_departamento_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_ciudad_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_ciudad_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_ciudad_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_genero_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_genero_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_genero_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_genero_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_genero_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_fecha_nacimineto_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_fecha_nacimineto_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_fecha_nacimineto_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_fecha_nacimineto_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_fecha_nacimineto_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_edad_paciente()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_pacientes_edad_paciente'])) ? $this->New_label['bayer_pacientes_edad_paciente'] : "EDAD PACIENTE"; 
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_edad_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_edad_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_edad_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_edad_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_acudiente_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_acudiente_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_acudiente_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_acudiente_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_acudiente_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_telefono_acudiente_paciente()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono_acudiente_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono_acudiente_paciente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_telefono_acudiente_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_telefono_acudiente_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_codigo_xofigo()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_codigo_xofigo_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_codigo_xofigo_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_status_paciente()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_status_paciente_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_status_paciente_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_id_ultima_gestion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_id_ultima_gestion']) || $this->NM_cmp_hidden['bayer_pacientes_id_ultima_gestion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_id_ultima_gestion_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_id_ultima_gestion_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_pacientes_usuario_creacion()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_pacientes_usuario_creacion']) || $this->NM_cmp_hidden['bayer_pacientes_usuario_creacion'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_pacientes_usuario_creacion_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_pacientes_usuario_creacion_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_id_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_id_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_id_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_id_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_id_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_producto_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_producto_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_producto_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_nombre_referencia()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_nombre_referencia_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_nombre_referencia_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_clasificacion_patologica_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_clasificacion_patologica_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_clasificacion_patologica_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_clasificacion_patologica_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_clasificacion_patologica_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_tratamiento_previo()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_tratamiento_previo']) || $this->NM_cmp_hidden['bayer_tratamiento_tratamiento_previo'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_tratamiento_previo_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_tratamiento_previo_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_consentimiento_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_consentimiento_tratamiento'])) ? $this->New_label['bayer_tratamiento_consentimiento_tratamiento'] : "CONSENTIMIENTO TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_consentimiento_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_consentimiento_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_consentimiento_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_consentimiento_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_fecha_inicio_terapia_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_fecha_inicio_terapia_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_fecha_inicio_terapia_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_fecha_inicio_terapia_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_regimen_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_regimen_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_regimen_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_regimen_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_regimen_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_asegurador_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_asegurador_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_asegurador_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_operador_logistico_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_operador_logistico_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_operador_logistico_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_punto_entrega()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_punto_entrega_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_punto_entrega_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_otros_operadores_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_otros_operadores_tratamiento'])) ? $this->New_label['bayer_tratamiento_otros_operadores_tratamiento'] : "OTROS OPERADORES TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_otros_operadores_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_otros_operadores_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_otros_operadores_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_otros_operadores_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_medios_adquisicion_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_medios_adquisicion_tratamiento'])) ? $this->New_label['bayer_tratamiento_medios_adquisicion_tratamiento'] : "MEDIOS ADQUISICION TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_medios_adquisicion_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_medios_adquisicion_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_medios_adquisicion_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_medios_adquisicion_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_ips_atiende_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_ips_atiende_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_ips_atiende_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_ips_atiende_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_ips_atiende_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_medico_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_medico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_medico_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_medico_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_medico_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_especialidad_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_especialidad_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_especialidad_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_especialidad_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_especialidad_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_paramedico_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_paramedico_tratamiento'])) ? $this->New_label['bayer_tratamiento_paramedico_tratamiento'] : "PARAMEDICO TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_paramedico_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_paramedico_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_paramedico_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_zona_atencion_paramedico_tratamiento()
 {
   global $nm_saida;
   ...
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_zona_atencion_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_zona_atencion_paramedico_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_zona_atencion_paramedico_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_ciudad_base_paramedico_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_ciudad_base_paramedico_tratamiento'])) ? $this->New_label['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] : "CIUDAD BASE PARAMEDICO TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_ciudad_base_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_ciudad_base_paramedico_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_ciudad_base_paramedico_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_bayer_tratamiento_notas_adjuntos_tratamiento()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['bayer_tratamiento_notas_adjuntos_tratamiento'])) ? $this->New_label['bayer_tratamiento_notas_adjuntos_tratamiento'] : "NOTAS ADJUNTOS TRATAMIENTO"; 
   if (!isset($this->NM_cmp_hidden['bayer_tratamiento_notas_adjuntos_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_notas_adjuntos_tratamiento'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . " css_bayer_tratamiento_notas_adjuntos_tratamiento_label\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
// 
//----- 
...
// 
   $SC_Label = (isset($this->New_label['bayer_pacientes_id_paciente'])) ? $this->New_label['bayer_pacientes_id_paciente'] : "ID PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_id_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_estado_paciente'])) ? $this->New_label['bayer_pacientes_estado_paciente'] : "ESTADO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_estado_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_fecha_activacion_paciente'])) ? $this->New_label['bayer_pacientes_fecha_activacion_paciente'] : "FECHA ACTIVACION PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_fecha_activacion_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_fecha_retiro_paciente'])) ? $this->New_label['bayer_pacientes_fecha_retiro_paciente'] : "FECHA RETIRO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_fecha_retiro_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_motivo_retiro_paciente'])) ? $this->New_label['bayer_pacientes_motivo_retiro_paciente'] : "MOTIVO RETIRO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_motivo_retiro_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_observacion_motivo_retiro_paciente'])) ? $this->New_label['bayer_pacientes_observacion_motivo_retiro_paciente'] : "OBSERVACION MOTIVO RETIRO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_observacion_motivo_retiro_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_identificacion_paciente'])) ? $this->New_label['bayer_pacientes_identificacion_paciente'] : "IDENTIFICACION PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_identificacion_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_nombre_paciente'])) ? $this->New_label['bayer_pacientes_nombre_paciente'] : "NOMBRE PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_nombre_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_apellido_paciente'])) ? $this->New_label['bayer_pacientes_apellido_paciente'] : "APELLIDO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_apellido_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_telefono_paciente'])) ? $this->New_label['bayer_pacientes_telefono_paciente'] : "TELEFONO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_telefono_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_telefono2_paciente'])) ? $this->New_label['bayer_pacientes_telefono2_paciente'] : "TELEFONO2 PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_telefono2_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_telefono3_paciente'])) ? $this->New_label['bayer_pacientes_telefono3_paciente'] : "TELEFONO3 PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_telefono3_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_correo_paciente'])) ? $this->New_label['bayer_pacientes_correo_paciente'] : "CORREO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_correo_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_direccion_paciente'])) ? $this->New_label['bayer_pacientes_direccion_paciente'] : "DIRECCION PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_direccion_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_barrio_paciente'])) ? $this->New_label['bayer_pacientes_barrio_paciente'] : "BARRIO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_barrio_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_departamento_paciente'])) ? $this->New_label['bayer_pacientes_departamento_paciente'] : "DEPARTAMENTO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_departamento_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_ciudad_paciente'])) ? $this->New_label['bayer_pacientes_ciudad_paciente'] : "CIUDAD PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_ciudad_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_genero_paciente'])) ? $this->New_label['bayer_pacientes_genero_paciente'] : "GENERO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_genero_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_fecha_nacimineto_paciente'])) ? $this->New_label['bayer_pacientes_fecha_nacimineto_paciente'] : "FECHA NACIMINETO PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_fecha_nacimineto_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_edad_paciente'])) ? $this->New_label['bayer_pacientes_edad_paciente'] : "EDAD PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_edad_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_acudiente_paciente'])) ? $this->New_label['bayer_pacientes_acudiente_paciente'] : "ACUDIENTE PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_acudiente_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_telefono_acudiente_paciente'])) ? $this->New_label['bayer_pacientes_telefono_acudiente_paciente'] : "TELEFONO ACUDIENTE PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_telefono_acudiente_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_codigo_xofigo'])) ? $this->New_label['bayer_pacientes_codigo_xofigo'] : "CODIGO XOFIGO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_codigo_xofigo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_status_paciente'])) ? $this->New_label['bayer_pacientes_status_paciente'] : "STATUS PACIENTE"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_status_paciente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_id_ultima_gestion'])) ? $this->New_label['bayer_pacientes_id_ultima_gestion'] : "ID ULTIMA GESTION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_id_ultima_gestion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_pacientes_usuario_creacion'])) ? $this->New_label['bayer_pacientes_usuario_creacion'] : "USUARIO CREACION"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_pacientes_usuario_creacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_id_tratamiento'])) ? $this->New_label['bayer_tratamiento_id_tratamiento'] : "ID TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_id_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_producto_tratamiento'])) ? $this->New_label['bayer_tratamiento_producto_tratamiento'] : "PRODUCTO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_producto_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_nombre_referencia'])) ? $this->New_label['bayer_tratamiento_nombre_referencia'] : "NOMBRE REFERENCIA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_nombre_referencia'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_clasificacion_patologica_tratamiento'])) ? $this->New_label['bayer_tratamiento_clasificacion_patologica_tratamiento'] : "CLASIFICACION PATOLOGICA TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_clasificacion_patologica_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_tratamiento_previo'])) ? $this->New_label['bayer_tratamiento_tratamiento_previo'] : "TRATAMIENTO PREVIO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_tratamiento_previo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_consentimiento_tratamiento'])) ? $this->New_label['bayer_tratamiento_consentimiento_tratamiento'] : "CONSENTIMIENTO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_consentimiento_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_fecha_inicio_terapia_tratamiento'])) ? $this->New_label['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] : "FECHA INICIO TERAPIA TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_regimen_tratamiento'])) ? $this->New_label['bayer_tratamiento_regimen_tratamiento'] : "REGIMEN TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_regimen_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_asegurador_tratamiento'])) ? $this->New_label['bayer_tratamiento_asegurador_tratamiento'] : "ASEGURADOR TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_asegurador_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_operador_logistico_tratamiento'])) ? $this->New_label['bayer_tratamiento_operador_logistico_tratamiento'] : "OPERADOR LOGISTICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_operador_logistico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_punto_entrega'])) ? $this->New_label['bayer_tratamiento_punto_entrega'] : "PUNTO ENTREGA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_punto_entrega'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'])) ? $this->New_label['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'] : "FECHA ULTIMA RECLAMACION TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_otros_operadores_tratamiento'])) ? $this->New_label['bayer_tratamiento_otros_operadores_tratamiento'] : "OTROS OPERADORES TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_otros_operadores_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_medios_adquisicion_tratamiento'])) ? $this->New_label['bayer_tratamiento_medios_adquisicion_tratamiento'] : "MEDIOS ADQUISICION TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_medios_adquisicion_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_ips_atiende_tratamiento'])) ? $this->New_label['bayer_tratamiento_ips_atiende_tratamiento'] : "IPS ATIENDE TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_ips_atiende_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_medico_tratamiento'])) ? $this->New_label['bayer_tratamiento_medico_tratamiento'] : "MEDICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_medico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_especialidad_tratamiento'])) ? $this->New_label['bayer_tratamiento_especialidad_tratamiento'] : "ESPECIALIDAD TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_especialidad_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_paramedico_tratamiento'])) ? $this->New_label['bayer_tratamiento_paramedico_tratamiento'] : "PARAMEDICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_paramedico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_zona_atencion_paramedico_tratamiento'])) ? $this->New_label['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] : "ZONA ATENCION PARAMEDICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_ciudad_base_paramedico_tratamiento'])) ? $this->New_label['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] : "CIUDAD BASE PARAMEDICO TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['bayer_tratamiento_notas_adjuntos_tratamiento'])) ? $this->New_label['bayer_tratamiento_notas_adjuntos_tratamiento'] : "NOTAS ADJUNTOS TRATAMIENTO"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['labels']['bayer_tratamiento_notas_adjuntos_tratamiento'] = $SC_Label; 
...
// 
   ...
   $this->SC_top[]     = "bayer_pacientes_motivo_retiro_paciente"; 
   $this->SC_pag_pdf[] = "bayer_pacientes_motivo_retiro_paciente"; 
   $this->SC_top[]     = "bayer_pacientes_genero_paciente"; 
   $this->SC_pag_pdf[] = "bayer_pacientes_genero_paciente"; 
   $this->SC_top[]     = "bayer_tratamiento_producto_tratamiento"; 
   $this->SC_pag_pdf[] = "bayer_tratamiento_producto_tratamiento"; 
   $this->SC_top[]     = "bayer_tratamiento_medico_tratamiento"; 
   $this->SC_pag_pdf[] = "bayer_tratamiento_medico_tratamiento"; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       $Nivel_gb = 1;
   ...
   {  
          ...
          {  
              ...
              $SC_arg_Gby['bayer_pacientes_motivo_retiro_paciente'] = (isset($this->bayer_pacientes_motivo_retiro_paciente)) ? $this->bayer_pacientes_motivo_retiro_paciente : "";
              $SC_arg_Gby['bayer_pacientes_genero_paciente'] = (isset($this->bayer_pacientes_genero_paciente)) ? $this->bayer_pacientes_genero_paciente : "";
              $SC_arg_Gby['bayer_tratamiento_producto_tratamiento'] = (isset($this->bayer_tratamiento_producto_tratamiento)) ? $this->bayer_tratamiento_producto_tratamiento : "";
              $SC_arg_Gby['bayer_tratamiento_medico_tratamiento'] = (isset($this->bayer_tratamiento_medico_tratamiento)) ? $this->bayer_tratamiento_medico_tratamiento : "";
              $SC_lst_Gby = array();
              $gb_ok      = false;
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp'] as $cmp => $sql)
              {
              ...
              if (!empty($SC_lst_Gby))
              {
                  ...
                  $this->bayer_pacientes_motivo_retiro_paciente_Old = (isset($this->bayer_pacientes_motivo_retiro_paciente)) ? $this->bayer_pacientes_motivo_retiro_paciente : "";
                  $this->bayer_pacientes_genero_paciente_Old = (isset($this->bayer_pacientes_genero_paciente)) ? $this->bayer_pacientes_genero_paciente : "";
                  $this->bayer_tratamiento_producto_tratamiento_Old = (isset($this->bayer_tratamiento_producto_tratamiento)) ? $this->bayer_tratamiento_producto_tratamiento : "";
                  $this->bayer_tratamiento_medico_tratamiento_Old = (isset($this->bayer_tratamiento_medico_tratamiento)) ? $this->bayer_tratamiento_medico_tratamiento : "";
              }
          }  
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opc_psq'])
          {
              ...
              if ($temp == "bayer_pacientes_fecha_activacion_paciente")
              {
                  $conteudo_x = $teste;
              ...
              if ($temp == "bayer_pacientes_fecha_retiro_paciente")
              {
                  $conteudo_x = $teste;
                  nm_conv_limpa_dado($conteudo_x, "");
                  if (is_numeric($conteudo_x) && $conteudo_x > 0) 
              ...
              if ($temp == "bayer_pacientes_fecha_nacimineto_paciente")
              {
                  $conteudo_x = $teste;
                  nm_conv_limpa_dado($conteudo_x, "");
                  if (is_numeric($conteudo_x) && $conteudo_x > 0) 
              ...
              if ($temp == "bayer_tratamiento_fecha_inicio_terapia_tratamiento")
              {
                  $conteudo_x = $teste;
                  nm_conv_limpa_dado($conteudo_x, "");
                  if (is_numeric($conteudo_x) && $conteudo_x > 0) 
              ...
              if ($temp == "bayer_tratamiento_fecha_ultima_reclamacion_tratamiento")
              {
                  $conteudo_x = $teste;
                  nm_conv_limpa_dado($conteudo_x, "");
                  if (is_numeric($conteudo_x) && $conteudo_x > 0) 
          ...
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_id_paciente'] = $this->Res->array_total_bayer_pacientes_id_paciente;
          ksort($this->Res->array_total_bayer_pacientes_estado_paciente);
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_estado_paciente'] = $this->Res->array_total_bayer_pacientes_estado_paciente;
          ksort($this->Res->array_total_bayer_pacientes_motivo_retiro_paciente);
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_motivo_retiro_paciente'] = $this->Res->array_total_bayer_pacientes_motivo_retiro_paciente;
          ksort($this->Res->array_total_bayer_pacientes_genero_paciente);
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_genero_paciente'] = $this->Res->array_total_bayer_pacientes_genero_paciente;
          ksort($this->Res->array_total_bayer_tratamiento_producto_tratamiento);
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_producto_tratamiento'] = $this->Res->array_total_bayer_tratamiento_producto_tratamiento;
          ksort($this->Res->array_total_bayer_tratamiento_medico_tratamiento);
          $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_medico_tratamiento'] = $this->Res->array_total_bayer_tratamiento_medico_tratamiento;
      }
 ...
 function NM_grid_bayer_pacientes_id_paciente()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_id_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_id_paciente_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_id_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_estado_paciente()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_estado_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_estado_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_estado_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_fecha_activacion_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_fecha_activacion_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_fecha_activacion_paciente'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_pacientes_fecha_activacion_paciente); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_fecha_activacion_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_fecha_activacion_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_fecha_activacion_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_fecha_retiro_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_fecha_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_fecha_retiro_paciente'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_pacientes_fecha_retiro_paciente); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_fecha_retiro_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_fecha_retiro_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_fecha_retiro_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_motivo_retiro_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_motivo_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_motivo_retiro_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_motivo_retiro_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_motivo_retiro_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_motivo_retiro_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_motivo_retiro_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_observacion_motivo_retiro_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_observacion_motivo_retiro_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_observacion_motivo_retiro_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_observacion_motivo_retiro_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_observacion_motivo_retiro_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_observacion_motivo_retiro_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_observacion_motivo_retiro_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_identificacion_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_identificacion_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_identificacion_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_identificacion_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_identificacion_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_identificacion_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_identificacion_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_nombre_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_nombre_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_nombre_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_nombre_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_nombre_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_nombre_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_nombre_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_apellido_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_apellido_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_apellido_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_apellido_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_apellido_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_apellido_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_apellido_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_telefono_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_telefono_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_telefono_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_telefono_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_telefono_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_telefono2_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono2_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono2_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_telefono2_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_telefono2_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_telefono2_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_telefono2_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_telefono3_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono3_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono3_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_telefono3_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_telefono3_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_telefono3_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_telefono3_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_correo_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_correo_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_correo_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_correo_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_correo_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_correo_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_correo_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_direccion_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_direccion_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_direccion_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_direccion_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_direccion_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_direccion_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_direccion_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_barrio_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_barrio_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_barrio_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_barrio_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_barrio_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_barrio_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_barrio_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_departamento_paciente()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_departamento_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_departamento_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_departamento_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_ciudad_paciente()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_ciudad_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_ciudad_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_ciudad_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_genero_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_genero_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_genero_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_genero_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_genero_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_genero_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_genero_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_fecha_nacimineto_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_fecha_nacimineto_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_fecha_nacimineto_paciente'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_pacientes_fecha_nacimineto_paciente); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_fecha_nacimineto_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_fecha_nacimineto_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_fecha_nacimineto_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_edad_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_edad_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_edad_paciente'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_pacientes_edad_paciente); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_edad_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_edad_paciente_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_edad_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_acudiente_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_acudiente_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_acudiente_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_acudiente_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_acudiente_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_acudiente_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_acudiente_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_telefono_acudiente_paciente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_telefono_acudiente_paciente']) || $this->NM_cmp_hidden['bayer_pacientes_telefono_acudiente_paciente'] != "off") { 
          $conteudo = $this->bayer_pacientes_telefono_acudiente_paciente; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_telefono_acudiente_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_telefono_acudiente_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_telefono_acudiente_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_codigo_xofigo()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_codigo_xofigo_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_codigo_xofigo_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_codigo_xofigo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_status_paciente()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_status_paciente_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_status_paciente_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_status_paciente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_id_ultima_gestion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_id_ultima_gestion']) || $this->NM_cmp_hidden['bayer_pacientes_id_ultima_gestion'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_pacientes_id_ultima_gestion); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_id_ultima_gestion_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_id_ultima_gestion_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_id_ultima_gestion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_pacientes_usuario_creacion()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_pacientes_usuario_creacion']) || $this->NM_cmp_hidden['bayer_pacientes_usuario_creacion'] != "off") { 
          $conteudo = $this->bayer_pacientes_usuario_creacion; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_pacientes_usuario_creacion_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_pacientes_usuario_creacion_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_pacientes_usuario_creacion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_id_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_id_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_id_tratamiento'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_tratamiento_id_tratamiento); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_id_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_id_tratamiento_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_id_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_producto_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_producto_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_producto_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_producto_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_nombre_referencia()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_nombre_referencia_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_nombre_referencia_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_nombre_referencia_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_clasificacion_patologica_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_clasificacion_patologica_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_clasificacion_patologica_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_clasificacion_patologica_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_clasificacion_patologica_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_clasificacion_patologica_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_clasificacion_patologica_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_tratamiento_previo()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_tratamiento_previo']) || $this->NM_cmp_hidden['bayer_tratamiento_tratamiento_previo'] != "off") { 
          $conteudo = $this->bayer_tratamiento_tratamiento_previo; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_tratamiento_previo_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_tratamiento_previo_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_tratamiento_previo_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_consentimiento_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_consentimiento_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_consentimiento_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_consentimiento_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_consentimiento_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_consentimiento_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_consentimiento_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_fecha_inicio_terapia_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_fecha_inicio_terapia_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_tratamiento_fecha_inicio_terapia_tratamiento); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_fecha_inicio_terapia_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_fecha_inicio_terapia_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_fecha_inicio_terapia_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_regimen_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_regimen_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_regimen_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_regimen_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_regimen_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_regimen_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_regimen_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_asegurador_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_asegurador_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_asegurador_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_asegurador_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_operador_logistico_tratamiento()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_operador_logistico_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_operador_logistico_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_operador_logistico_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_punto_entrega()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_punto_entrega_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_punto_entrega_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_punto_entrega_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_fecha_ultima_reclamacion_tratamiento'] != "off") { 
          $conteudo = NM_encode_input($this->bayer_tratamiento_fecha_ultima_reclamacion_tratamiento); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_fecha_ultima_reclamacion_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_otros_operadores_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_otros_operadores_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_otros_operadores_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_otros_operadores_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_otros_operadores_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_otros_operadores_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_otros_operadores_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_medios_adquisicion_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_medios_adquisicion_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_medios_adquisicion_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_medios_adquisicion_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_medios_adquisicion_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_medios_adquisicion_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_medios_adquisicion_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_ips_atiende_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_ips_atiende_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_ips_atiende_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_ips_atiende_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_ips_atiende_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_ips_atiende_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_ips_atiende_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_medico_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_medico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_medico_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_medico_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_medico_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_medico_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_medico_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_especialidad_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_especialidad_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_especialidad_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_especialidad_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_especialidad_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_especialidad_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_especialidad_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_paramedico_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_paramedico_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_paramedico_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_paramedico_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_paramedico_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_paramedico_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_zona_atencion_paramedico_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_zona_atencion_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_zona_atencion_paramedico_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_zona_atencion_paramedico_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_zona_atencion_paramedico_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_zona_atencion_paramedico_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_ciudad_base_paramedico_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_ciudad_base_paramedico_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_ciudad_base_paramedico_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_ciudad_base_paramedico_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_ciudad_base_paramedico_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_ciudad_base_paramedico_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_bayer_tratamiento_notas_adjuntos_tratamiento()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['bayer_tratamiento_notas_adjuntos_tratamiento']) || $this->NM_cmp_hidden['bayer_tratamiento_notas_adjuntos_tratamiento'] != "off") { 
          $conteudo = $this->bayer_tratamiento_notas_adjuntos_tratamiento; 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          } 
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . " css_bayer_tratamiento_notas_adjuntos_tratamiento_grid_line\"  style=\"" . $this->Css_Cmp['css_bayer_tratamiento_notas_adjuntos_tratamiento_grid_line'] . "\"  align=\"\" valign=\"\"   HEIGHT=\"0px\"><span id=\"id_sc_field_bayer_tratamiento_notas_adjuntos_tratamiento_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function quebra_bayer_pacientes_motivo_retiro_paciente_sc_free_group_by($Cmp_qb, $Where_qb) 
 {
   ...
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = false;
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = false;
   $this->sc_proc_quebra_bayer_pacientes_motivo_retiro_paciente = true; 
   $this->Tot->quebra_bayer_pacientes_motivo_retiro_paciente_sc_free_group_by($Cmp_qb, $Where_qb);
   $conteudo = $tot_bayer_pacientes_motivo_retiro_paciente[0] ;  
   $this->count_bayer_pacientes_motivo_retiro_paciente = $tot_bayer_pacientes_motivo_retiro_paciente[1];
   $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente = array(); 
   $conteudo = $this->bayer_pacientes_motivo_retiro_paciente; 
   $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['bayer_pacientes_motivo_retiro_paciente']))
   {
       $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente[0]['lab'] = $this->nmgp_label_quebras['bayer_pacientes_motivo_retiro_paciente']; 
   }
   else
   {
       $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente[0]['lab'] = "MOTIVO RETIRO PACIENTE"; 
   }
   $this->sc_proc_quebra_bayer_pacientes_motivo_retiro_paciente = false; 
 } 
 function quebra_bayer_pacientes_genero_paciente_sc_free_group_by($Cmp_qb, $Where_qb) 
 {
   ...
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = false;
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = false;
   $this->sc_proc_quebra_bayer_pacientes_genero_paciente = true; 
   $this->Tot->quebra_bayer_pacientes_genero_paciente_sc_free_group_by($Cmp_qb, $Where_qb);
   $conteudo = $tot_bayer_pacientes_genero_paciente[0] ;  
   $this->count_bayer_pacientes_genero_paciente = $tot_bayer_pacientes_genero_paciente[1];
   $this->campos_quebra_bayer_pacientes_genero_paciente = array(); 
   $conteudo = $this->bayer_pacientes_genero_paciente; 
   $this->campos_quebra_bayer_pacientes_genero_paciente[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['bayer_pacientes_genero_paciente']))
   {
       $this->campos_quebra_bayer_pacientes_genero_paciente[0]['lab'] = $this->nmgp_label_quebras['bayer_pacientes_genero_paciente']; 
   }
   else
   {
       $this->campos_quebra_bayer_pacientes_genero_paciente[0]['lab'] = "GENERO PACIENTE"; 
   }
   $this->sc_proc_quebra_bayer_pacientes_genero_paciente = false; 
 } 
 function quebra_bayer_tratamiento_producto_tratamiento_sc_free_group_by($Cmp_qb, $Where_qb) 
 {
   ...
   $this->sc_proc_quebra_bayer_pacientes_genero_paciente = false;
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = false;
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = true; 
   $this->Tot->quebra_bayer_tratamiento_producto_tratamiento_sc_free_group_by($Cmp_qb, $Where_qb);
   $conteudo = $tot_bayer_tratamiento_producto_tratamiento[0] ;  
   $this->count_bayer_tratamiento_producto_tratamiento = $tot_bayer_tratamiento_producto_tratamiento[1];
   $this->campos_quebra_bayer_tratamiento_producto_tratamiento = array(); 
   $conteudo = $this->bayer_tratamiento_producto_tratamiento; 
   $this->campos_quebra_bayer_tratamiento_producto_tratamiento[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['bayer_tratamiento_producto_tratamiento']))
   {
       $this->campos_quebra_bayer_tratamiento_producto_tratamiento[0]['lab'] = $this->nmgp_label_quebras['bayer_tratamiento_producto_tratamiento']; 
   }
   else
   {
       $this->campos_quebra_bayer_tratamiento_producto_tratamiento[0]['lab'] = "PRODUCTO TRATAMIENTO"; 
   }
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = false; 
 } 
 function quebra_bayer_tratamiento_medico_tratamiento_sc_free_group_by($Cmp_qb, $Where_qb) 
 {
   ...
   $this->sc_proc_quebra_bayer_pacientes_genero_paciente = false;
   $this->sc_proc_quebra_bayer_tratamiento_producto_tratamiento = false;
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = true; 
   $this->Tot->quebra_bayer_tratamiento_medico_tratamiento_sc_free_group_by($Cmp_qb, $Where_qb);
   $conteudo = $tot_bayer_tratamiento_medico_tratamiento[0] ;  
   $this->count_bayer_tratamiento_medico_tratamiento = $tot_bayer_tratamiento_medico_tratamiento[1];
   $this->campos_quebra_bayer_tratamiento_medico_tratamiento = array(); 
   $conteudo = $this->bayer_tratamiento_medico_tratamiento; 
   $this->campos_quebra_bayer_tratamiento_medico_tratamiento[0]['cmp'] = $conteudo; 
   if (isset($this->nmgp_label_quebras['bayer_tratamiento_medico_tratamiento']))
   {
       $this->campos_quebra_bayer_tratamiento_medico_tratamiento[0]['lab'] = $this->nmgp_label_quebras['bayer_tratamiento_medico_tratamiento']; 
   }
   else
   {
       $this->campos_quebra_bayer_tratamiento_medico_tratamiento[0]['lab'] = "MEDICO TRATAMIENTO"; 
   }
   $this->sc_proc_quebra_bayer_tratamiento_medico_tratamiento = false; 
 } 
 ...
 { global
   ...
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_pacientes_id_paciente'] : 0;
 ...
 { global
   ...
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_pacientes_estado_paciente'] : 0;
 ...
 function quebra_bayer_pacientes_motivo_retiro_paciente_sc_free_group_by_top() 
 { global
          $bayer_pacientes_motivo_retiro_paciente_ant_desc, 
          $nm_saida, $tot_bayer_pacientes_motivo_retiro_paciente; 
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_pacientes_motivo_retiro_paciente'] : 0;
   $bayer_pacientes_motivo_retiro_paciente_ant_desc = $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente[0]['cmp'];
   static $cont_quebra_bayer_pacientes_motivo_retiro_paciente = 0; 
   $cont_quebra_bayer_pacientes_motivo_retiro_paciente++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['rows_emb']++;
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H4 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_bayer_pacientes_motivo_retiro_paciente[0]['cmp'] ;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_bayer_pacientes_motivo_retiro_paciente = "<table>"; 
   foreach ($this->campos_quebra_bayer_pacientes_motivo_retiro_paciente as $cada_campo) 
   { 
       $this->Label_bayer_pacientes_motivo_retiro_paciente .= "<tr>"; 
       if ($this->SC_tab_quebra > 0)
       {
           $this->Label_bayer_pacientes_motivo_retiro_paciente .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_bayer_pacientes_motivo_retiro_paciente .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_bayer_pacientes_motivo_retiro_paciente .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_bayer_pacientes_motivo_retiro_paciente .= "</tr>"; 
   } 
   $this->Label_bayer_pacientes_motivo_retiro_paciente .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"   " . "colspan=\"" . $colspan . "\"" . " align=\"left\">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_bayer_pacientes_motivo_retiro_paciente . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_bayer_pacientes_genero_paciente_sc_free_group_by_top() 
 { global
          $bayer_pacientes_genero_paciente_ant_desc, 
          $nm_saida, $tot_bayer_pacientes_genero_paciente; 
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_pacientes_genero_paciente'] : 0;
   $bayer_pacientes_genero_paciente_ant_desc = $this->campos_quebra_bayer_pacientes_genero_paciente[0]['cmp'];
   static $cont_quebra_bayer_pacientes_genero_paciente = 0; 
   $cont_quebra_bayer_pacientes_genero_paciente++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['rows_emb']++;
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H5 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_bayer_pacientes_genero_paciente[0]['cmp'] ;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_bayer_pacientes_genero_paciente = "<table>"; 
   foreach ($this->campos_quebra_bayer_pacientes_genero_paciente as $cada_campo) 
   { 
       $this->Label_bayer_pacientes_genero_paciente .= "<tr>"; 
       if ($this->SC_tab_quebra > 0)
       {
           $this->Label_bayer_pacientes_genero_paciente .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_bayer_pacientes_genero_paciente .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_bayer_pacientes_genero_paciente .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_bayer_pacientes_genero_paciente .= "</tr>"; 
   } 
   $this->Label_bayer_pacientes_genero_paciente .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"   " . "colspan=\"" . $colspan . "\"" . " align=\"left\">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_bayer_pacientes_genero_paciente . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_bayer_tratamiento_producto_tratamiento_sc_free_group_by_top() 
 { global
          $bayer_tratamiento_producto_tratamiento_ant_desc, 
          $nm_saida, $tot_bayer_tratamiento_producto_tratamiento; 
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_tratamiento_producto_tratamiento'] : 0;
   $bayer_tratamiento_producto_tratamiento_ant_desc = $this->campos_quebra_bayer_tratamiento_producto_tratamiento[0]['cmp'];
   static $cont_quebra_bayer_tratamiento_producto_tratamiento = 0; 
   $cont_quebra_bayer_tratamiento_producto_tratamiento++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['rows_emb']++;
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['opcao'] == "pdf" && !$this->Print_All)
   {
       $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H6 style=\"font-size:0;padding:1px\">" .  $this->campos_quebra_bayer_tratamiento_producto_tratamiento[0]['cmp'] ;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_bayer_tratamiento_producto_tratamiento = "<table>"; 
   foreach ($this->campos_quebra_bayer_tratamiento_producto_tratamiento as $cada_campo) 
   { 
       $this->Label_bayer_tratamiento_producto_tratamiento .= "<tr>"; 
       if ($this->SC_tab_quebra > 0)
       {
           $this->Label_bayer_tratamiento_producto_tratamiento .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_bayer_tratamiento_producto_tratamiento .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_bayer_tratamiento_producto_tratamiento .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_bayer_tratamiento_producto_tratamiento .= "</tr>"; 
   } 
   $this->Label_bayer_tratamiento_producto_tratamiento .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"   " . "colspan=\"" . $colspan . "\"" . " align=\"left\">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_bayer_tratamiento_producto_tratamiento . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
 ...
 function quebra_bayer_tratamiento_medico_tratamiento_sc_free_group_by_top() 
 { global
          $bayer_tratamiento_medico_tratamiento_ant_desc, 
          $nm_saida, $tot_bayer_tratamiento_medico_tratamiento; 
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['bayer_tratamiento_medico_tratamiento'] : 0;
   $bayer_tratamiento_medico_tratamiento_ant_desc = $this->campos_quebra_bayer_tratamiento_medico_tratamiento[0]['cmp'];
   static $cont_quebra_bayer_tratamiento_medico_tratamiento = 0; 
   $cont_quebra_bayer_tratamiento_medico_tratamiento++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['rows_emb']++;
   ...
   $colspan = $this->NM_colspan;
   $this->Label_bayer_tratamiento_medico_tratamiento = "<table>"; 
   foreach ($this->campos_quebra_bayer_tratamiento_medico_tratamiento as $cada_campo) 
   { 
       $this->Label_bayer_tratamiento_medico_tratamiento .= "<tr>"; 
       if ($this->SC_tab_quebra > 0)
       {
           $this->Label_bayer_tratamiento_medico_tratamiento .= "<td class=\"" . $this->css_scGridBlockLineBg . "\" style=\"width: " . $this->SC_tab_quebra . "px;\">&nbsp;</td>"; 
       }
       $this->Label_bayer_tratamiento_medico_tratamiento .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_bayer_tratamiento_medico_tratamiento .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_bayer_tratamiento_medico_tratamiento .= "</tr>"; 
   } 
   $this->Label_bayer_tratamiento_medico_tratamiento .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"   " . "colspan=\"" . $colspan . "\"" . " align=\"left\">" . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_bayer_tratamiento_medico_tratamiento . $nm_fecha_pdf_old . "</TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['embutida_grid'] && $this->nm_prim_linha)
   { 
       $nm_saida->saida("##NM@@"); 
