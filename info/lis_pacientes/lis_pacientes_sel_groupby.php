...
function Sel_processa_out($sel_groupby)
{
   ...
   elseif ($sel_groupby != $groupby_atual || $Change_free_groupby)
   {
       ...
       if ($sel_groupby == "sc_free_group_by")
       {
           ...
           $tab_arr_groubby_cmp['bayer_pacientes_motivo_retiro_paciente'] = array('cmp' => "bayer_pacientes.MOTIVO_RETIRO_PACIENTE", 'ind' => 2);
           $tab_arr_groubby_cmp['bayer_pacientes_genero_paciente'] = array('cmp' => "bayer_pacientes.GENERO_PACIENTE", 'ind' => 3);
           $tab_arr_groubby_cmp['bayer_tratamiento_producto_tratamiento'] = array('cmp' => "bayer_tratamiento.PRODUCTO_TRATAMIENTO", 'ind' => 4);
           $tab_arr_groubby_cmp['bayer_tratamiento_medico_tratamiento'] = array('cmp' => "bayer_tratamiento.MEDICO_TRATAMIENTO", 'ind' => 5);
           ...
           $tab_arr_groubby_sql[2] = array('cmp' => "bayer_pacientes.MOTIVO_RETIRO_PACIENTE", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "bayer_pacientes.GENERO_PACIENTE", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "bayer_tratamiento.PRODUCTO_TRATAMIENTO", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "bayer_tratamiento.MEDICO_TRATAMIENTO", 'ord' => 'asc');
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['bayer_pacientes_id_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_id_paciente'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_id_paciente'] : "ID PACIENTE";
   $arr_campos_free['bayer_pacientes_estado_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_estado_paciente'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_estado_paciente'] : "ESTADO PACIENTE";
   $arr_campos_free['bayer_pacientes_motivo_retiro_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_motivo_retiro_paciente'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_motivo_retiro_paciente'] : "MOTIVO RETIRO PACIENTE";
   $arr_campos_free['bayer_pacientes_genero_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_genero_paciente'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_pacientes_genero_paciente'] : "GENERO PACIENTE";
   $arr_campos_free['bayer_tratamiento_producto_tratamiento']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_tratamiento_producto_tratamiento'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_tratamiento_producto_tratamiento'] : "PRODUCTO TRATAMIENTO";
   $arr_campos_free['bayer_tratamiento_medico_tratamiento']  = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_tratamiento_medico_tratamiento'])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']['bayer_tratamiento_medico_tratamiento'] : "MEDICO TRATAMIENTO";
