...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____lis_pacientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____lis_pacientes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lis_pacientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['lis_pacientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['lis_pacientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['lis_pacientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['lis_pacientes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['lis_pacientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['lis_pacientes']['embutida_filho'] as $ind => $sc_init)
          {
