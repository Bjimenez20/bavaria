...
class lis_pacientes_total
{
   ...
   //----- 
   function resumo_sc_free_group_by($destino_resumo, &$array_total_bayer_pacientes_id_paciente, &$array_total_bayer_pacientes_estado_paciente, &$array_total_bayer_pacientes_motivo_retiro_paciente, &$array_total_bayer_pacientes_genero_paciente, &$array_total_bayer_tratamiento_producto_tratamiento, &$array_total_bayer_tratamiento_medico_tratamiento)
   {
      global $nada, $nm_lang;
   ...
   foreach ($all_sql_free as $cmp_gb)
   {
      ...
      { 
         $comando  = "select count(*), bayer_pacientes.ID_PACIENTE, bayer_pacientes.ESTADO_PACIENTE, bayer_pacientes.MOTIVO_RETIRO_PACIENTE, bayer_pacientes.GENERO_PACIENTE, bayer_tratamiento.PRODUCTO_TRATAMIENTO, bayer_tratamiento.MEDICO_TRATAMIENTO from " . $this->Ini->nm_tabela . " " .  $this->sc_where_atual . " group by " . $free_group_by . "  " . $nmgp_order_by;
      } 
      ...
      foreach ($array_db_total as $registro)
      {
         ...
         $bayer_pacientes_motivo_retiro_paciente      = $registro[3];
         $bayer_pacientes_motivo_retiro_paciente_orig = $registro[3];
         $conteudo = $registro[3];
         ...
         $bayer_pacientes_genero_paciente      = $registro[4];
         $bayer_pacientes_genero_paciente_orig = $registro[4];
         $conteudo = $registro[4];
         ...
         $bayer_tratamiento_producto_tratamiento      = $registro[5];
         $bayer_tratamiento_producto_tratamiento_orig = $registro[5];
         $conteudo = $registro[5];
         ...
         $bayer_tratamiento_medico_tratamiento      = $registro[6];
         $bayer_tratamiento_medico_tratamiento_orig = $registro[6];
         $conteudo = $registro[6];
