...
class lis_pacientes_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
      ...
      {
          $this->array_total_bayer_pacientes_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_id_paciente'];
          $this->array_total_bayer_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_estado_paciente'];
          $this->array_total_bayer_pacientes_motivo_retiro_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_motivo_retiro_paciente'];
          $this->array_total_bayer_pacientes_genero_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_genero_paciente'];
          $this->array_total_bayer_tratamiento_producto_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_producto_tratamiento'];
          $this->array_total_bayer_tratamiento_medico_tratamiento = $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_medico_tratamiento'];
      }
      else
      {
          $this->array_total_bayer_pacientes_id_paciente = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_id_paciente'] = $this->array_total_bayer_pacientes_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_estado_paciente'] = $this->array_total_bayer_pacientes_estado_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_motivo_retiro_paciente'] = $this->array_total_bayer_pacientes_motivo_retiro_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_pacientes_genero_paciente'] = $this->array_total_bayer_pacientes_genero_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_producto_tratamiento'] = $this->array_total_bayer_tratamiento_producto_tratamiento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['arr_total']['bayer_tratamiento_medico_tratamiento'] = $this->array_total_bayer_tratamiento_medico_tratamiento;
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_bayer_pacientes_id_paciente, $this->array_total_bayer_pacientes_estado_paciente, $this->array_total_bayer_pacientes_motivo_retiro_paciente, $this->array_total_bayer_pacientes_genero_paciente, $this->array_total_bayer_tratamiento_producto_tratamiento, $this->array_total_bayer_tratamiento_medico_tratamiento);
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $bayer_pacientes_id_paciente = $Busca_temp['bayer_pacientes_id_paciente']; 
          ...
          $bayer_pacientes_estado_paciente = $Busca_temp['bayer_pacientes_estado_paciente']; 
          ...
          $bayer_pacientes_fecha_retiro_paciente = $Busca_temp['bayer_pacientes_fecha_retiro_paciente']; 
   ...
   //---- 
   function adiciona_registro($quebra_bayer_pacientes_id_paciente, $quebra_bayer_pacientes_estado_paciente, $quebra_bayer_pacientes_motivo_retiro_paciente, $quebra_bayer_pacientes_genero_paciente, $quebra_bayer_tratamiento_producto_tratamiento, $quebra_bayer_tratamiento_medico_tratamiento, $quebra_bayer_pacientes_id_paciente_orig, $quebra_bayer_pacientes_estado_paciente_orig, $quebra_bayer_pacientes_motivo_retiro_paciente_orig, $quebra_bayer_pacientes_genero_paciente_orig, $quebra_bayer_tratamiento_producto_tratamiento_orig, $quebra_bayer_tratamiento_medico_tratamiento_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['lis_pacientes']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->bayer_pacientes_id_paciente, $this->bayer_pacientes_estado_paciente, $this->bayer_pacientes_motivo_retiro_paciente, $this->bayer_pacientes_genero_paciente, $this->bayer_tratamiento_producto_tratamiento, $this->bayer_tratamiento_medico_tratamiento, $this->bayer_pacientes_id_paciente_orig,  $this->bayer_pacientes_estado_paciente_orig,  $this->bayer_pacientes_motivo_retiro_paciente_orig,  $this->bayer_pacientes_genero_paciente_orig,  $this->bayer_tratamiento_producto_tratamiento_orig,  $this->bayer_tratamiento_medico_tratamiento_orig);
            }
   }
//
