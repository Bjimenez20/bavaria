...
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "bayer_pacientes_identificacion_paciente";
   ...
   $tab_blk_campos[] = "bayer_pacientes_telefono_paciente";
   $tab_ger_campos['bayer_pacientes_telefono2_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_telefono2_paciente";
   $tab_ger_campos['bayer_pacientes_telefono3_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_telefono3_paciente";
   $tab_ger_campos['bayer_pacientes_correo_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_correo_paciente";
   $tab_ger_campos['bayer_pacientes_direccion_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_direccion_paciente";
   $tab_ger_campos['bayer_pacientes_barrio_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_barrio_paciente";
   ...
   $tab_blk_campos[] = "bayer_pacientes_genero_paciente";
   $tab_ger_campos['bayer_pacientes_fecha_nacimineto_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_fecha_nacimineto_paciente";
   $tab_ger_campos['bayer_pacientes_edad_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_edad_paciente";
   $tab_ger_campos['bayer_pacientes_acudiente_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_acudiente_paciente";
   $tab_ger_campos['bayer_pacientes_telefono_acudiente_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_telefono_acudiente_paciente";
   ...
   $tab_blk_campos[] = "bayer_pacientes_id_ultima_gestion";
   $tab_ger_campos['bayer_pacientes_usuario_creacion'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_usuario_creacion";
   $tab_ger_campos['bayer_tratamiento_id_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_id_tratamiento";
   ...
   $tab_blk_campos[] = "bayer_tratamiento_clasificacion_patologica_tratamiento";
   $tab_ger_campos['bayer_tratamiento_tratamiento_previo'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_tratamiento_previo";
   $tab_ger_campos['bayer_tratamiento_consentimiento_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_consentimiento_tratamiento";
   $tab_ger_campos['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_fecha_inicio_terapia_tratamiento";
   $tab_ger_campos['bayer_tratamiento_regimen_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_regimen_tratamiento";
   ...
   $tab_blk_campos[] = "bayer_tratamiento_fecha_ultima_reclamacion_tratamiento";
   $tab_ger_campos['bayer_tratamiento_otros_operadores_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_otros_operadores_tratamiento";
   $tab_ger_campos['bayer_tratamiento_medios_adquisicion_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_medios_adquisicion_tratamiento";
   $tab_ger_campos['bayer_tratamiento_ips_atiende_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_ips_atiende_tratamiento";
   ...
   $tab_blk_campos[] = "bayer_tratamiento_especialidad_tratamiento";
   $tab_ger_campos['bayer_tratamiento_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_paramedico_tratamiento";
   $tab_ger_campos['bayer_tratamiento_zona_atencion_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_zona_atencion_paramedico_tratamiento";
   $tab_ger_campos['bayer_tratamiento_ciudad_base_paramedico_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_ciudad_base_paramedico_tratamiento";
   $tab_ger_campos['bayer_tratamiento_notas_adjuntos_tratamiento'] = "on";
   $tab_blk_campos[] = "bayer_tratamiento_notas_adjuntos_tratamiento";
