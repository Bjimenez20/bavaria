...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["bayer_pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_id_paciente"] : "ID PACIENTE";
   ...
   $tab_labels["bayer_pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_retiro_paciente"] : "FECHA RETIRO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_motivo_retiro_paciente"] : "MOTIVO RETIRO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_observacion_motivo_retiro_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_observacion_motivo_retiro_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_observacion_motivo_retiro_paciente"] : "OBSERVACION MOTIVO RETIRO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_identificacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_identificacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_identificacion_paciente"] : "IDENTIFICACION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   ...
   $tab_labels["bayer_pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono2_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono2_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono2_paciente"] : "TELEFONO2 PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono3_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono3_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono3_paciente"] : "TELEFONO3 PACIENTE";
   ...
   $tab_labels["bayer_pacientes_correo_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_correo_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_correo_paciente"] : "CORREO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_direccion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_direccion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_direccion_paciente"] : "DIRECCION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_barrio_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_barrio_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_barrio_paciente"] : "BARRIO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   ...
   $tab_labels["bayer_pacientes_genero_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_genero_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_genero_paciente"] : "GENERO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_fecha_nacimineto_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_nacimineto_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_fecha_nacimineto_paciente"] : "FECHA NACIMINETO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_edad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_edad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_edad_paciente"] : "EDAD PACIENTE";
   ...
   $tab_labels["bayer_pacientes_acudiente_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_acudiente_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_acudiente_paciente"] : "ACUDIENTE PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono_acudiente_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono_acudiente_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_telefono_acudiente_paciente"] : "TELEFONO ACUDIENTE PACIENTE";
   ...
   $tab_labels["bayer_pacientes_codigo_xofigo"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_codigo_xofigo"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_codigo_xofigo"] : "CODIGO XOFIGO";
   ...
   $tab_labels["bayer_pacientes_status_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_status_paciente"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_status_paciente"] : "STATUS PACIENTE";
   ...
   $tab_labels["bayer_pacientes_id_ultima_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_id_ultima_gestion"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_id_ultima_gestion"] : "ID ULTIMA GESTION";
   ...
   $tab_labels["bayer_pacientes_usuario_creacion"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_usuario_creacion"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_pacientes_usuario_creacion"] : "USUARIO CREACION";
   ...
   $tab_labels["bayer_tratamiento_id_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_id_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_id_tratamiento"] : "ID TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_nombre_referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_nombre_referencia"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_nombre_referencia"] : "NOMBRE REFERENCIA";
   ...
   $tab_labels["bayer_tratamiento_clasificacion_patologica_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_clasificacion_patologica_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_clasificacion_patologica_tratamiento"] : "CLASIFICACION PATOLOGICA TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_tratamiento_previo"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_tratamiento_previo"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_tratamiento_previo"] : "TRATAMIENTO PREVIO";
   ...
   $tab_labels["bayer_tratamiento_consentimiento_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_consentimiento_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_consentimiento_tratamiento"] : "CONSENTIMIENTO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_fecha_inicio_terapia_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"] : "FECHA INICIO TERAPIA TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_regimen_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_regimen_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_regimen_tratamiento"] : "REGIMEN TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_punto_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_punto_entrega"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_punto_entrega"] : "PUNTO ENTREGA";
   ...
   $tab_labels["bayer_tratamiento_fecha_ultima_reclamacion_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_fecha_ultima_reclamacion_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_fecha_ultima_reclamacion_tratamiento"] : "FECHA ULTIMA RECLAMACION TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_otros_operadores_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_otros_operadores_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_otros_operadores_tratamiento"] : "OTROS OPERADORES TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_medios_adquisicion_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_medios_adquisicion_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_medios_adquisicion_tratamiento"] : "MEDIOS ADQUISICION TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_ips_atiende_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_ips_atiende_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_ips_atiende_tratamiento"] : "IPS ATIENDE TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_medico_tratamiento"] : "MEDICO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_especialidad_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_especialidad_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_especialidad_tratamiento"] : "ESPECIALIDAD TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_paramedico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_paramedico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_paramedico_tratamiento"] : "PARAMEDICO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_zona_atencion_paramedico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_zona_atencion_paramedico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_zona_atencion_paramedico_tratamiento"] : "ZONA ATENCION PARAMEDICO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_ciudad_base_paramedico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_ciudad_base_paramedico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_ciudad_base_paramedico_tratamiento"] : "CIUDAD BASE PARAMEDICO TRATAMIENTO";
   ...
   $tab_labels["bayer_tratamiento_notas_adjuntos_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_notas_adjuntos_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['lis_pacientes']['labels']["bayer_tratamiento_notas_adjuntos_tratamiento"] : "NOTAS ADJUNTOS TRATAMIENTO";
