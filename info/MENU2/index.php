...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("BAYER_EA") . "/BAYER_EA_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Histórico Reclamación";
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA']) == "on")
{
    $MENU2_menuData['data'] .= "item_11|.|" . $nm_var_lab[6] . "|MENU2_form_php.php?sc_item_menu=item_11&sc_apl_menu=BAYER_EA&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->MENU2_target('_self') . "|" . "\n";
}
else
{
...
$str_disabled = "N";
$str_link = "MENU2_form_php.php?sc_item_menu=item_11&sc_apl_menu=BAYER_EA&sc_apl_link=" . urlencode($MENU2_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['MENU2']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['BAYER_EA']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
