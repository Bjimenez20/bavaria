...
class BD_General_xls
{
   ...
   function NM_export_bayer_pacientes_identificacion_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_identificacion_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_fecha_nacimineto_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_fecha_nacimineto_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_genero_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_genero_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_barrio_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_barrio_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_direccion_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_direccion_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_telefono_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_telefono2_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono2_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_correo_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_correo_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_acudiente_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_acudiente_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_telefono_acudiente_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_telefono_acudiente_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_fecha_inicio_terapia_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_fecha_inicio_terapia_tratamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_ips_atiende_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_ips_atiende_tratamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_tratamiento_especialidad_tratamiento()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_tratamiento_especialidad_tratamiento, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_fecha_retiro_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_fecha_retiro_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
   ...
   function NM_export_bayer_pacientes_motivo_retiro_paciente()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->xls_col) . $this->xls_row, $this->bayer_pacientes_motivo_retiro_paciente, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->xls_col++;
   }
