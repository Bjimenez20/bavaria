...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_bayer_pacientes_status_paciente')
      {
          $bayer_pacientes_status_paciente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_bayer_pacientes_status_paciente($bayer_pacientes_status_paciente);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_bayer_pacientes_status_paciente($bayer_pacientes_status_paciente)
   {
      $bayer_pacientes_status_paciente = substr($this->Db->qstr($bayer_pacientes_status_paciente), 1, -1);
            $bayer_pacientes_status_paciente_look = substr($this->Db->qstr($bayer_pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct bayer_pacientes.STATUS_PACIENTE from " . $this->Ini->nm_tabela . " where bayer_tratamiento.NOMBRE_REFERENCIA NOT LIKE 'XARELTO%' AND bayer_tratamiento.NOMBRE_REFERENCIA NOT LIKE 'EYLIA%' and  bayer_pacientes.STATUS_PACIENTE like '%" . $bayer_pacientes_status_paciente . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "bayer_pacientes_edad_paciente";$Nm_numeric[] = "bayer_pacientes_codigo_xofigo";$Nm_numeric[] = "bayer_pacientes_id_ultima_gestion";$Nm_numeric[] = "bayer_tratamiento_id_tratamiento";$Nm_numeric[] = "bayer_tratamiento_id_paciente_fk";
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_bayer_pacientes_status_paciente_cond#NMF#' + search_get_sel_txt('SC_bayer_pacientes_status_paciente_cond') + '@NMF@';
  str_out += 'SC_bayer_pacientes_status_paciente#NMF#' + search_get_text('SC_bayer_pacientes_status_paciente') + '@NMF@';
  str_out += 'id_ac_bayer_pacientes_status_paciente#NMF#' + search_get_text('id_ac_bayer_pacientes_status_paciente') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_bayer_pacientes_status_paciente").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_bayer_pacientes_status_paciente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_bayer_pacientes_status_paciente").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_bayer_pacientes_status_paciente").val( $(this).val() );
       }
     }
   });
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $bayer_pacientes_status_paciente_cond, $bayer_pacientes_status_paciente, $bayer_pacientes_status_paciente_autocomp,
      ...
      { 
          ...
          $bayer_pacientes_fecha_activacion_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_fecha_activacion_paciente']; 
          $bayer_pacientes_fecha_activacion_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_fecha_activacion_paciente_cond']; 
          $bayer_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_estado_paciente']; 
          $bayer_pacientes_estado_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_estado_paciente_cond']; 
          $bayer_pacientes_status_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_status_paciente']; 
          $bayer_pacientes_status_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_status_paciente_cond']; 
      ...
      if (!isset($bayer_pacientes_status_paciente_cond) || empty($bayer_pacientes_status_paciente_cond))
      {
         $bayer_pacientes_status_paciente_cond = "qp";
      }
      ...
      $str_hide_bayer_pacientes_status_paciente = (in_array($bayer_pacientes_status_paciente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($bayer_pacientes_status_paciente) || $bayer_pacientes_status_paciente == "")
      {
          $bayer_pacientes_status_paciente = "";
      }
      if (isset($bayer_pacientes_status_paciente) && !empty($bayer_pacientes_status_paciente))
      {
         $tmp_pos = strpos($bayer_pacientes_status_paciente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $bayer_pacientes_status_paciente = substr($bayer_pacientes_status_paciente, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_bayer_pacientes_estado_paciente" name="bayer_pacientes_estado_paciente_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['bayer_pacientes_status_paciente'])) ? $this->New_label['bayer_pacientes_status_paciente'] : "STATUS PACIENTE"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_bayer_pacientes_status_paciente_cond" name="bayer_pacientes_status_paciente_cond" onChange="nm_campos_between(document.getElementById('id_vis_bayer_pacientes_status_paciente'), this, 'bayer_pacientes_status_paciente')">
       <OPTION value="qp" <?php if ("qp" == $bayer_pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $bayer_pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $bayer_pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $bayer_pacientes_status_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bayer_pacientes_status_paciente" <?php echo $str_hide_bayer_pacientes_status_paciente?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 ...
 $nmgp_tab_label .= "bayer_pacientes_status_paciente?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $bayer_pacientes_status_paciente_look = substr($this->Db->qstr($bayer_pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct bayer_pacientes.STATUS_PACIENTE from " . $this->Ini->nm_tabela . " where bayer_tratamiento.NOMBRE_REFERENCIA NOT LIKE 'XARELTO%' AND bayer_tratamiento.NOMBRE_REFERENCIA NOT LIKE 'EYLIA%' and bayer_pacientes.STATUS_PACIENTE = '$bayer_pacientes_status_paciente_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$bayer_pacientes_status_paciente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$bayer_pacientes_status_paciente];
      }
      else
      {
          $sAutocompValue = $bayer_pacientes_status_paciente;
      }
?>
<INPUT  type="text" id="SC_bayer_pacientes_status_paciente" name="bayer_pacientes_status_paciente" value="<?php echo NM_encode_input($bayer_pacientes_status_paciente) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_bayer_pacientes_status_paciente" name="bayer_pacientes_status_paciente_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_bayer_pacientes_status_paciente'), document.F1.bayer_pacientes_status_paciente_cond, 'bayer_pacientes_status_paciente');
   document.F1.bayer_pacientes_status_paciente.value = "";
   document.F1.bayer_pacientes_status_paciente_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "bayer_fundem/BD_General";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_bayer_pacientes_status_paciente_cond'] = 'cond';
      $tp_fields['SC_bayer_pacientes_status_paciente'] = 'text_aut';
      $tp_fields['id_ac_bayer_pacientes_status_paciente'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $bayer_pacientes_fecha_activacion_paciente_cond, $bayer_pacientes_fecha_activacion_paciente, $bayer_pacientes_fecha_activacion_paciente_autocomp,
             $bayer_pacientes_estado_paciente_cond, $bayer_pacientes_estado_paciente, $bayer_pacientes_estado_paciente_autocomp,
             $bayer_pacientes_status_paciente_cond, $bayer_pacientes_status_paciente, $bayer_pacientes_status_paciente_autocomp, $nmgp_tab_label;
      ...
      if (!empty($bayer_pacientes_status_paciente_autocomp) && empty($bayer_pacientes_status_paciente))
      {
          $bayer_pacientes_status_paciente = $bayer_pacientes_status_paciente_autocomp;
      }
      ...
      $bayer_pacientes_status_paciente_cond_salva = $bayer_pacientes_status_paciente_cond; 
      if (!isset($bayer_pacientes_status_paciente_input_2) || $bayer_pacientes_status_paciente_input_2 == "")
      {
          $bayer_pacientes_status_paciente_input_2 = $bayer_pacientes_status_paciente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_fecha_activacion_paciente'] = $bayer_pacientes_fecha_activacion_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_fecha_activacion_paciente_cond'] = $bayer_pacientes_fecha_activacion_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_estado_paciente'] = $bayer_pacientes_estado_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_estado_paciente_cond'] = $bayer_pacientes_estado_paciente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_status_paciente'] = $bayer_pacientes_status_paciente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['BD_General']['campos_busca']['bayer_pacientes_status_paciente_cond'] = $bayer_pacientes_status_paciente_cond_salva; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['bayer_pacientes_status_paciente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['bayer_pacientes_status_paciente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['bayer_pacientes_status_paciente'] = $bayer_pacientes_status_paciente;
      }
      ...
      //----- $bayer_pacientes_status_paciente
      $this->Date_part = false;
      if (isset($bayer_pacientes_status_paciente) || $bayer_pacientes_status_paciente_cond == "nu" || $bayer_pacientes_status_paciente_cond == "nn" || $bayer_pacientes_status_paciente_cond == "ep" || $bayer_pacientes_status_paciente_cond == "ne")
      {
         $this->monta_condicao("bayer_pacientes.STATUS_PACIENTE", $bayer_pacientes_status_paciente_cond, $bayer_pacientes_status_paciente, "", "bayer_pacientes_status_paciente");
      }
   }
