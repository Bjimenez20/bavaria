...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_status_paciente'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "bayer_pacientes_status_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_status_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_status_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_status_paciente"] : "STATUS PACIENTE";
   ...
   $tab_labels["bayer_pacientes_estado_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_estado_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_estado_paciente"] : "ESTADO PACIENTE";
   ...
   {
       $tab_def_campos['pap'] = "CONCAT('PAP',bayer_pacientes.ID_PACIENTE)";
       $tab_converte["CONCAT('PAP',bayer_pacientes.ID_PACIENTE)"]   = "pap";
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_fecha_activacion_paciente'] = "cmp_maior_30_3";
       $tab_converte["cmp_maior_30_3"]   = "bayer_pacientes_fecha_activacion_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   $tab_ger_campos['bayer_pacientes_nombre_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_nombre_paciente'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "bayer_pacientes_nombre_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   $tab_ger_campos['bayer_pacientes_apellido_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_apellido_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "bayer_pacientes_apellido_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_identificacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_identificacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_identificacion_paciente"] : "IDENTIFICACION PACIENTE";
   $tab_ger_campos['bayer_pacientes_fecha_nacimineto_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_fecha_nacimineto_paciente'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "bayer_pacientes_fecha_nacimineto_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_fecha_nacimineto_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_fecha_nacimineto_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_fecha_nacimineto_paciente"] : "FECHA NACIMINETO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_edad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_edad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_edad_paciente"] : "EDAD PACIENTE";
   $tab_ger_campos['bayer_pacientes_genero_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_genero_paciente'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "bayer_pacientes_genero_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_genero_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_genero_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_genero_paciente"] : "GENERO PACIENTE";
   $tab_ger_campos['bayer_pacientes_departamento_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_departamento_paciente'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "bayer_pacientes_departamento_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_departamento_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_departamento_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_departamento_paciente"] : "DEPARTAMENTO PACIENTE";
   $tab_ger_campos['bayer_pacientes_ciudad_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_ciudad_paciente'] = "cmp_maior_30_10";
       $tab_converte["cmp_maior_30_10"]   = "bayer_pacientes_ciudad_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_ciudad_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_ciudad_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_ciudad_paciente"] : "CIUDAD PACIENTE";
   $tab_ger_campos['bayer_pacientes_barrio_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_barrio_paciente'] = "cmp_maior_30_11";
       $tab_converte["cmp_maior_30_11"]   = "bayer_pacientes_barrio_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_barrio_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_barrio_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_barrio_paciente"] : "BARRIO PACIENTE";
   $tab_ger_campos['bayer_pacientes_direccion_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_direccion_paciente'] = "cmp_maior_30_12";
       $tab_converte["cmp_maior_30_12"]   = "bayer_pacientes_direccion_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_direccion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_direccion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_direccion_paciente"] : "DIRECCION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   ...
   $tab_labels["bayer_pacientes_telefono2_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono2_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono2_paciente"] : "TELEFONO2 PACIENTE";
   $tab_ger_campos['bayer_pacientes_correo_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_correo_paciente'] = "cmp_maior_30_15";
       $tab_converte["cmp_maior_30_15"]   = "bayer_pacientes_correo_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_correo_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_correo_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_correo_paciente"] : "CORREO PACIENTE";
   $tab_ger_campos['bayer_pacientes_acudiente_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_acudiente_paciente'] = "cmp_maior_30_16";
       $tab_converte["cmp_maior_30_16"]   = "bayer_pacientes_acudiente_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_acudiente_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_acudiente_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_acudiente_paciente"] : "ACUDIENTE PACIENTE";
   $tab_ger_campos['bayer_pacientes_telefono_acudiente_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_telefono_acudiente_paciente'] = "cmp_maior_30_17";
       $tab_converte["cmp_maior_30_17"]   = "bayer_pacientes_telefono_acudiente_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_telefono_acudiente_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono_acudiente_paciente"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_pacientes_telefono_acudiente_paciente"] : "TELEFONO ACUDIENTE PACIENTE";
   $tab_ger_campos['bayer_tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_producto_tratamiento'] = "cmp_maior_30_18";
       $tab_converte["cmp_maior_30_18"]   = "bayer_tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_fecha_inicio_terapia_tratamiento'] = "cmp_maior_30_19";
       $tab_converte["cmp_maior_30_19"]   = "bayer_tratamiento_fecha_inicio_terapia_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_fecha_inicio_terapia_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_fecha_inicio_terapia_tratamiento"] : "FECHA INICIO TERAPIA TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_asegurador_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_asegurador_tratamiento'] = "cmp_maior_30_20";
       $tab_converte["cmp_maior_30_20"]   = "bayer_tratamiento_asegurador_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_asegurador_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_asegurador_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_asegurador_tratamiento"] : "ASEGURADOR TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_ips_atiende_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_ips_atiende_tratamiento'] = "cmp_maior_30_21";
       $tab_converte["cmp_maior_30_21"]   = "bayer_tratamiento_ips_atiende_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_ips_atiende_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_ips_atiende_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_ips_atiende_tratamiento"] : "IPS ATIENDE TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_operador_logistico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_operador_logistico_tratamiento'] = "cmp_maior_30_22";
       $tab_converte["cmp_maior_30_22"]   = "bayer_tratamiento_operador_logistico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_operador_logistico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_operador_logistico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_operador_logistico_tratamiento"] : "OPERADOR LOGISTICO TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_punto_entrega'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_punto_entrega'] = "cmp_maior_30_23";
       $tab_converte["cmp_maior_30_23"]   = "bayer_tratamiento_punto_entrega";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_punto_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_punto_entrega"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_punto_entrega"] : "PUNTO ENTREGA";
   $tab_ger_campos['bayer_tratamiento_medico_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_medico_tratamiento'] = "cmp_maior_30_24";
       $tab_converte["cmp_maior_30_24"]   = "bayer_tratamiento_medico_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_medico_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_medico_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_medico_tratamiento"] : "MEDICO TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_especialidad_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_especialidad_tratamiento'] = "cmp_maior_30_25";
       $tab_converte["cmp_maior_30_25"]   = "bayer_tratamiento_especialidad_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_especialidad_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_especialidad_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_especialidad_tratamiento"] : "ESPECIALIDAD TRATAMIENTO";
   $tab_ger_campos['bayer_tratamiento_dosis_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_dosis_tratamiento'] = "cmp_maior_30_26";
       $tab_converte["cmp_maior_30_26"]   = "bayer_tratamiento_dosis_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_dosis_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_dosis_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['BD_General']['labels']["bayer_tratamiento_dosis_tratamiento"] : "DOSIS TRATAMIENTO";
