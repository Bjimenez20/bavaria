...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_bayer_pacientes_status_paciente"  <?php echo $str_hide_bayer_pacientes_status_paciente?>><?php
      $bayer_pacientes_status_paciente_look = substr($this->Db->qstr($bayer_pacientes_status_paciente), 1, -1); 
      $nmgp_def_dados = array(); 
