...
function Sel_processa_out($sel_groupby)
{
   ...
   elseif ($sel_groupby != $groupby_atual || $Change_free_groupby)
   {
       ...
       if ($sel_groupby == "sc_free_group_by")
       {
           ...
           $tab_arr_groubby_cmp['id_paciente'] = array('cmp' => "ID_PACIENTE", 'ind' => 0);
           $tab_arr_groubby_cmp['estado_paciente'] = array('cmp' => "ESTADO_PACIENTE", 'ind' => 1);
           $tab_arr_groubby_sql[0] = array('cmp' => "ID_PACIENTE", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "ESTADO_PACIENTE", 'ord' => 'asc');
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['id_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']['id_paciente'])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']['id_paciente'] : "ID PACIENTE";
   $arr_campos_free['estado_paciente']  = (isset($_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']['estado_paciente'])) ? $_SESSION['sc_session'][$sc_init]['Informe_reclamacion']['labels']['estado_paciente'] : "ESTADO PACIENTE";
