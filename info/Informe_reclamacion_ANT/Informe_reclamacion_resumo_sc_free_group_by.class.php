...
class Informe_reclamacion_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
      ...
      {
          $this->array_total_bayer_pacientes_id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['bayer_pacientes_id_paciente'];
          $this->array_total_bayer_pacientes_estado_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['bayer_pacientes_estado_paciente'];
      }
      else
      {
          $this->array_total_bayer_pacientes_id_paciente = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['bayer_pacientes_id_paciente'] = $this->array_total_bayer_pacientes_id_paciente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_total']['bayer_pacientes_estado_paciente'] = $this->array_total_bayer_pacientes_estado_paciente;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->bayer_pacientes_fecha_retiro_paciente = $rs_res->fields[9] ;  
            $this->bayer_pacientes_motivo_retiro_paciente = $rs_res->fields[10] ;  
            $this->bayer_tratamiento_fecha_inicio_terapia_tratamiento = $rs_res->fields[11] ;  
            $this->bayer_pacientes_codigo_xofigo = $rs_res->fields[12] ;  
            $this->bayer_tratamiento_clasificacion_patologica_tratamiento = $rs_res->fields[13] ;  
            $this->bayer_tratamiento_producto_tratamiento = $rs_res->fields[14] ;  
            $this->bayer_tratamiento_nombre_referencia = $rs_res->fields[15] ;  
            $this->bayer_tratamiento_dosis_tratamiento = $rs_res->fields[16] ;  
            $this->bayer_gestiones_fecha_medicamento_hasta = $rs_res->fields[17] ;  
            $this->bayer_gestiones_numero_cajas = $rs_res->fields[18] ;  
            $this->bayer_tratamiento_asegurador_tratamiento = $rs_res->fields[19] ;  
            $this->bayer_tratamiento_operador_logistico_tratamiento = $rs_res->fields[20] ;  
            $this->bayer_tratamiento_punto_entrega = $rs_res->fields[21] ;  
            $this->bayer_tratamiento_ips_atiende_tratamiento = $rs_res->fields[22] ;  
            $this->bayer_tratamiento_regimen_tratamiento = $rs_res->fields[23] ;  
            $this->bayer_tratamiento_medico_tratamiento = $rs_res->fields[24] ;  
            $this->bayer_tratamiento_tratamiento_previo = $rs_res->fields[25] ;  
            $this->bayer_gestiones_reclamo_gestion = $rs_res->fields[26] ;  
            $this->bayer_gestiones_fecha_reclamacion_gestion = $rs_res->fields[27] ;  
            $this->bayer_gestiones_causa_no_reclamacion_gestion = $rs_res->fields[28] ;  
            $this->bayer_gestiones_descripcion_comunicacion_gestion = $rs_res->fields[29] ;  
            $this->bayer_gestiones_fecha_programada_gestion = $rs_res->fields[30] ;  
            $this->bayer_pacientes_id_ultima_gestion = $rs_res->fields[31] ;  
            $this->bayer_tratamiento_id_tratamiento = $rs_res->fields[32] ;  
            $this->bayer_tratamiento_id_paciente_fk = $rs_res->fields[33] ;  
            $this->bayer_gestiones_paap = $rs_res->fields[34] ;  
            $this->bayer_gestiones_sub_paap = $rs_res->fields[35] ;  
            $this->bayer_gestiones_barrera = $rs_res->fields[36] ;  
