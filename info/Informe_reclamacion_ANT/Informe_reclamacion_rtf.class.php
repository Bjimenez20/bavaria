...
class Informe_reclamacion_rtf
{
   ...
   {
         $this->bayer_gestiones_fecha_medicamento_hasta = html_entity_decode($this->bayer_gestiones_fecha_medicamento_hasta, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_gestiones_fecha_medicamento_hasta = strip_tags($this->bayer_gestiones_fecha_medicamento_hasta);
         if (!NM_is_utf8($this->bayer_gestiones_fecha_medicamento_hasta))
         {
         ...
         $this->bayer_gestiones_fecha_medicamento_hasta = str_replace('<', '&lt;', $this->bayer_gestiones_fecha_medicamento_hasta);
         $this->bayer_gestiones_fecha_medicamento_hasta = str_replace('>', '&gt;', $this->bayer_gestiones_fecha_medicamento_hasta);
         $this->texto_tag .= "<td>" . $this->bayer_gestiones_fecha_medicamento_hasta . "</td>\r\n";
   }
   ...
   {
         $this->bayer_pacientes_id_ultima_gestion = html_entity_decode($this->bayer_pacientes_id_ultima_gestion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_pacientes_id_ultima_gestion = strip_tags($this->bayer_pacientes_id_ultima_gestion);
   ...
   {
         $this->bayer_tratamiento_id_tratamiento = html_entity_decode($this->bayer_tratamiento_id_tratamiento, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_id_tratamiento = strip_tags($this->bayer_tratamiento_id_tratamiento);
   ...
   {
         $this->bayer_tratamiento_id_paciente_fk = html_entity_decode($this->bayer_tratamiento_id_paciente_fk, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->bayer_tratamiento_id_paciente_fk = strip_tags($this->bayer_tratamiento_id_paciente_fk);
