...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["prueba_____Informe_reclamacion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["prueba_____Informe_reclamacion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Informe_reclamacion</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Informe_reclamacion']['embutida_filho'] as $ind => $sc_init)
          {
