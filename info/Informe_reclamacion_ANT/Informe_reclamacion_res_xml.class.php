...
class Informe_reclamacion_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['Informe_reclamacion']['arr_export']['data'];
      $contr_rowspan = array();
      $tit_rowspan   = array();
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          $lab           = "";
          $cmp           = false;
          $xml_registro  = "<Informe_reclamacion";
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
              {
