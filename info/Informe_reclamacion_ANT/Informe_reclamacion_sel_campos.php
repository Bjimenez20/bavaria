...
function Sel_cmp_init()
{
   ...
   $tab_blk_campos[] = "bayer_pacientes_fecha_retiro_paciente";
   $tab_ger_campos['bayer_pacientes_motivo_retiro_paciente'] = "on";
   $tab_blk_campos[] = "bayer_pacientes_motivo_retiro_paciente";
   ...
   $tab_blk_campos[] = "bayer_gestiones_fecha_medicamento_hasta";
   ...
   $tab_blk_campos[] = "bayer_tratamiento_id_paciente_fk";
