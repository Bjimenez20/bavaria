...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_fecha_activacion_paciente'] = "cmp_maior_30_1";
       $tab_converte["cmp_maior_30_1"]   = "bayer_pacientes_fecha_activacion_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_fecha_activacion_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_fecha_activacion_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_fecha_activacion_paciente"] : "FECHA ACTIVACION PACIENTE";
   ...
   $tab_labels["bayer_pacientes_nombre_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_nombre_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_nombre_paciente"] : "NOMBRE PACIENTE";
   ...
   $tab_labels["bayer_pacientes_apellido_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_apellido_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_apellido_paciente"] : "APELLIDO PACIENTE";
   $tab_ger_campos['bayer_pacientes_telefono_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_telefono_paciente'] = "cmp_maior_30_4";
       $tab_converte["cmp_maior_30_4"]   = "bayer_pacientes_telefono_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_telefono_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono_paciente"] : "TELEFONO PACIENTE";
   $tab_ger_campos['bayer_pacientes_telefono2_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_telefono2_paciente'] = "cmp_maior_30_5";
       $tab_converte["cmp_maior_30_5"]   = "bayer_pacientes_telefono2_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_telefono2_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono2_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono2_paciente"] : "TELEFONO2 PACIENTE";
   $tab_ger_campos['bayer_pacientes_telefono3_paciente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_pacientes_telefono3_paciente'] = "cmp_maior_30_6";
       $tab_converte["cmp_maior_30_6"]   = "bayer_pacientes_telefono3_paciente";
   }
   else
   {
   ...
   $tab_labels["bayer_pacientes_telefono3_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono3_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_telefono3_paciente"] : "TELEFONO3 PACIENTE";
   $tab_ger_campos['bayer_tratamiento_producto_tratamiento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_tratamiento_producto_tratamiento'] = "cmp_maior_30_7";
       $tab_converte["cmp_maior_30_7"]   = "bayer_tratamiento_producto_tratamiento";
   }
   else
   {
   ...
   $tab_labels["bayer_tratamiento_producto_tratamiento"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_tratamiento_producto_tratamiento"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_tratamiento_producto_tratamiento"] : "PRODUCTO TRATAMIENTO";
   $tab_ger_campos['bayer_gestiones_descripcion_comunicacion_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_descripcion_comunicacion_gestion'] = "cmp_maior_30_8";
       $tab_converte["cmp_maior_30_8"]   = "bayer_gestiones_descripcion_comunicacion_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_descripcion_comunicacion_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_descripcion_comunicacion_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_descripcion_comunicacion_gestion"] : "DESCRIPCION COMUNICACION GESTION";
   ...
   $tab_labels["bayer_gestiones_autor_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_autor_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_autor_gestion"] : "AUTOR GESTION";
   ...
   $tab_labels["bayer_pacientes_id_paciente"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_id_paciente"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_pacientes_id_paciente"] : "ID PACIENTE";
   $tab_ger_campos['bayer_gestiones_evento_adverso_gestion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bayer_gestiones_evento_adverso_gestion'] = "cmp_maior_30_9";
       $tab_converte["cmp_maior_30_9"]   = "bayer_gestiones_evento_adverso_gestion";
   }
   else
   {
   ...
   $tab_labels["bayer_gestiones_evento_adverso_gestion"]   = (isset($_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_evento_adverso_gestion"])) ? $_SESSION['sc_session'][$sc_init]['Conciliacion_in']['labels']["bayer_gestiones_evento_adverso_gestion"] : "EVENTO ADVERSO GESTION";
