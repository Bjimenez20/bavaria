...
$consulta_fechas = mysqli_query($conex, "SELECT * FROM bayer_historial_reclamacion WHERE FECHA_RECLAMACION3 LIKE '%2016-02-%'");
...
while ($dato = mysqli_fetch_array($consulta_fechas)) {
	...
	$update = mysqli_query($conex, "UPDATE bayer_historial_reclamacion
	SET
	RECLAMO3='',
	FECHA_RECLAMACION3='',
