                    ...
                    if ($sql) {
                        if ($evento_adverso == 'SI') {
                            if ($tipo_evento_adverso == 'Farmacovigilancia' || $tipo_evento_adverso == 'Tecnovigilancia') {
                                ...
                                <p class="aviso3" style=" width:68.9%; margin:auto auto;">EL SEGUIMIENTO HA SIDO INGRESADO SATISFACTORIAMENTE <?php echo $tipo_evento_adverso ?>.</p>
                                <br />
                                <br />
                                <center>
