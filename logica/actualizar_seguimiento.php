...
<body>
    ...
    $primera_linea = $_POST['cabo_primera_linea'];
    $segunda_linea = $_POST['cabo_segunda_linea'];
    $descripcion_linea = $_POST['cabo_descripcion'];
