...
require('../datos/parse_str.php');
	...
	if (isset($_POST['registrar'])) {
		...
		$insertar = mysqli_query($conex,"INSERT INTO bayer_envio_muestra (PAP, ESTATUS_PACIENTE, DOSIS, FECHA_SALIDA, FECHA_ENTREGA, NO_LOTE, ESTADO, USUARIO, FECHA_VENCIMIENTO, OBSERVACION)
