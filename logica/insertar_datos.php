...
<body>
	...
	if (isset($_POST['registrar'])) {
		...
		VALUES ('" . $CODIGO_XOFIGO . "','" . $estado_paciente . "','" . $status_paciente . "','" . $fecha_activacion . "','" . $tipo_identificacion . "','" . $identificacion . "','" . $nombre . "','" . $apellidos . "','" . $telefono1 . "','" . $telefono2 . "','" . $telefono3 . "','" . $telefono4 . "','" . $telefono5 . "','" . $correo . "','" . $direccion . "','" . $barrio . "','" . $departamento . "','" . $ciudad . "','" . $genero . "','" . $fecha_nacimiento . "','" . $edad . "','" . $acudiente . "','" . $telefono_acudiente . "','" . $usua . "','People Marketing')");
		echo mysqli_error($conex);
		if ($insertar) {
