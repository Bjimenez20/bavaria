...
?>
    ...
    <body>
        <?php
        include('../logica/consulta_asegurador.php');
        $url = "../presentacion/form_listado_asegurador.php";
        ...
        ?>
            <table border="0" align="center" bordercolor="#A1A1A1" width="100%" rules="cols">
                <tr>
                    <th class="botones">#</th>
                    <th class="botones">ASEGURADOR</th>
                ...
                ?>
                    <tr align="center">
                        <td><?php echo $fila1['ID_ASEGURADOR'] ?></td>
                        <td><?php echo $fila1['ASEGURADOR'] ?></td>
                        <td>
                            <a href="../presentacion/actualizar_asegurador.php?artid=<?php echo $fila1['ID_ASEGURADOR'] ?>" target="info"><img src="../presentacion/imagenes/button_edicion-y-agregado.png" alt="" width="135px" height="35px" title="EDITAR INFORMACION USUARIO" /></a>
                        </td>
                    </tr>
                <?php
                }
