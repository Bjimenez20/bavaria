        ...
        <form>
            <div class="col">
                <div class="accordion" id="accordionExample">
                    ...
                    $Seleccion = mysqli_query($conex, "SELECT * FROM `ipsen_aspirantes` AS P
                                    ...
                                    <div class="row mb-3">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    ?>
                                                            <select name="estado_paciente" id="estado_paciente" class="form-control ">
                                                                ...
                                                                <option>No conoce diagnostico</option>
                                                        ...
                                                        ?>
                                                            <input name="estado_paciente" class="form-control readonly " type="text" id="estado_paciente" readonly="readonly" value="<?php echo $fila['ESTADO_PACIENTE']; ?>">
                                                        <?php
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="date" class="form-control" name="fecha_activacion" id="fecha_activacion" readonly="readonly" value="<?php echo $fila['FECHA_ACTIVACION_ASPIRANTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" class="form-control" name="correo" id="correo" value="<?php echo $fila['CORREO_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" class="form-control" name="remitente" id="remitente" value="<?php echo $fila['REMITENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $fila['NOMBRE_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" class="form-control" name="apellidos" id="apellidos" value="<?php echo $fila['APELLIDO_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="identificacion" id="identificacion" class="form-control" value="<?php echo $fila['IDENTIFICACION_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="telefono1" class="form-control" id="telefono1" value="<?php echo $fila['TELEFONO_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="telefono2" class="form-control" id="telefono2" value="<?php echo $fila['TELEFONO2_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="telefono3" class="form-control" id="telefono3" value="<?php echo $fila['TELEFONO3_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="telefono4" class="form-control" id="telefono4" value="<?php echo $fila['TELEFONO4_PACIENTE']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <select class="form-control" name="departamento" id="departamento" onchange="mostrar_ciudades()">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="date" name="fecha_nacimiento" id="fecha_nacimiento" max="<?php echo date('Y-m-d'); ?>" class="form-control" value="<?= $fila['FECHA_NACIMIENTO_PACIENTE'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    <input type="text" name="edad" id="edad" class="form-control readonly" readonly value="<?php echo $fila['EDAD_PACIENTE'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" name="acudiente" id="acudiente" class="form-control" value="<?php echo $fila['ACUDIENTE_PACIENTE'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <input type="number" name="telefono_acudiente" id="telefono_acudiente" class="form-control" value="<?php echo $fila['TELEFONO_ACUDIENTE_PACIENTE'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <select type="text" name="consentimiento" id="consentimiento" class="form-control">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    <select type="text" name="regimen" id="regimen" class="form-control">
                                    ...
                                    if ($num1 > 0) {
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                        <input type="date" name="fecha_proxima_llamada" id="fecha_proxima_llamada" class="form-control" min="<?php echo date('Y-m-d'); ?>" value="<?= $FECHA_PROXIMA_LLAMADA ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col d-flex align-items-center">
                                                        <label for="" class="fw-bold">Descripcion de Comunicacion <span class="fw-bold text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-10">
                                                        <textarea class="form-control readonly" id="nota" name="nota" readonly><?php echo $NOTA ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                        <textarea class="form-control" id="nota_new" minlength="20" maxlength="5000" name="nota_new"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col my-5 d-flex justify-content-center">
                                    <button type="button" onclick="btnSubmit()" class="btn_registrar btn btn-modify bg-gradient text-white w-25">
                                        REGISTRAR
                                    </button>
                                </div>
                                </div>
...
<script>
    function btnSubmit() {
        ...
        var notaNewValidation = document.getElementById('nota_new');
        if (notaNewValidation.value.length < notaNewValidation.minLength) {
            Swal.fire({
                title: 'Error con la Descripcion Justificacion',
            ...
            axios.post('./../logica/aspirantes/modificacion/modificacion_aspirantes.php', date)
                .then(function(response) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed && response.data.tipo === 'success') {
                            setTimeout(() => {
                                var url = "../presentacion/form_aspirante_seguimiento.php";
                                var target = "info";
