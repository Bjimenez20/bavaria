...
?>
    ...
    <body>
        <?php
        include('../logica/consulta_operador.php');
        $url = "../presentacion/form_listado_operador.php";
            ...
            <table border="0" align="center" bordercolor="#A1A1A1" width="100%" rules="cols">
                ...
                ?>
                    <tr align="center">
                        ...
                        <td>
                            <a href="../presentacion/actualizar_operador.php?artid=<?php echo $fila1['ID_OPERADOR_LOGISTICO'] ?>" target="info"><img src="../presentacion/imagenes/button_edicion-y-agregado.png" alt="" width="135px" height="35px" /></a>
                        </td>
                    </tr>
                <?php
                }
