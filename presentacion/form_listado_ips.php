...
?>
    ...
    <body>
        <?php
        include('../logica/consulta_ips.php');
        $url = "../presentacion/form_listado_ips.php";
        ...
        ?>
            <table border="0" align="center" bordercolor="#A1A1A1" width="100%" rules="cols">
                ...
                ?>
                    <tr align="center">
                        <td><?php echo $fila1['ID_IPS'] ?></td>
                        <td><?php echo $fila1['IPS'] ?></td>
                        <td>
                            <a href="../presentacion/actualizar_ips.php?artid=<?php echo $fila1['ID_IPS'] ?>" target="info"><img src="../presentacion/imagenes/button_edicion-y-agregado.png" alt="" width="135px" height="35px" title="EDITAR INFORMACION USUARIO" /></a>
                        </td>
                    </tr>
                <?php
                }
