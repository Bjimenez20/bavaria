...
<body>
  <form id="cambio_contacto" name="cambio_contacto" method="post" action="../logica/importar_cambio_contacto.php" enctype="multipart/form-data" class="letra">
    <br><br><br>
    <table width="100%">
      <tr>
    ...
    <table width="95%">
      <tr>
        ...
        <td>
          <input type="submit" name="descargar" id="descargar" value="Exportar" class="btn_exp" title="DESCARGAR ESTRUCTURA" formaction="doc/estructura_cambio_fecha.csv" />
        </td>
      </tr>
      <tr>
        <td>
