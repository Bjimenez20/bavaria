...
//$mailer = new AttachMailer("pspbayer@encontactopeoplemarketing.com", "soporte@peoplecontact.cc,coordinacion@encontactopeoplemarketing.com, admin@encontactopeoplemarketing.com", "$causa_no_reclamacion - $pap ",$body);

$mailer = new AttachMailer("pspbayer@encontactopeoplemarketing.com", 
" andrea.arango@bayer.com, coordinacion.bayer@PSPSOLUTIONS-CO.COM,  andreanathalie.bulla@bayer.com, lider.adherencia1@PSPSOLUTIONS-CO.COM, coordinacion@encontactopeoplemarketing.com, soporte@peoplecontact.cc", "Apoyo Paciente Adempas - $pap ",$body);	
