...
while ($dato = mysqli_fetch_array($select_id)) {
    ...
    $MOTIVO_RECHAZO = $dato['MOTIVO_RECHAZO'];
}
$body = "
Buen dia,
<br />
...
<br>
<br>
<b>MOTIVO DEL RECHAZO:</b> $MOTIVO_RECHAZO
<br>
<br>
Cordial Saludo
<br>
