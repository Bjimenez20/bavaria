...
$mailer = new AttachMailer("pspbayer@encontactopeoplemarketing.com", "admin@encontactopeoplemarketing.com, coordinacion@encontactopeoplemarketing.com,laura.arciniegas@bayer.com", "Solicitud cambio estado paciente - $pap - ".$fecha."",$body2);	
}else{
$mailer = new AttachMailer("pspbayer@encontactopeoplemarketing.com", "admin@encontactopeoplemarketing.com, coordinacion@encontactopeoplemarketing.com", "Solicitud cambio estado paciente - $pap - ".$fecha."",$body);
}
